...
//echo "allo";
		...
		$imagepath=$GLOBALS['SITE_ROOT'].'image/catalog/'.$_POST['category_id'].".".$path[$ext];
		//echo "<br>".$imagepath;
		...
		//file_put_contents('/home/n7f9655/public_html/image/categorytmp/zzzz2.jpg', $image); //Where to save the image on your server
...
<h3>category_id <?if($new==1){?><a href="uploadphotocategory.php" >Changer d'item</a><?}?> <a href="interneusa.php" >Retour au MENU</a> <a href="listing.php?category_id=<?echo $_POST['category_id']?>" >Menu Listing</a></h3>
