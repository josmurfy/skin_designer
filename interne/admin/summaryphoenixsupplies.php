				...
				$yearnow=date("Y");
				  ...
				  for ($i=2018;$i<$yearnow+1;$i++){
					  ...
					  if($init==0){?>
							...
							<a href="https://phoenixliquidation.ca/interne/phoenixsupplies/admin/monthly.php?month=11&year=<?echo $i-1;?>&tout=" target='listing' >Novembre (<?echo $i-1;?>)</a>		
							</div>
<?if($_POST['tout']=="oui"){?>
...
<?$a=$b=$c=$d=$e=0;?>
							<div class="divTableRow">
							<div class="divTableCell">
							<a href="https://phoenixliquidation.ca/interne/phoenixsupplies/admin/monthly.php?month=12&year=<?echo $i-1;?>&tout=" target='listing' >Decembre (<?echo $i-1;?>)</a>		
							</div>
<?if($_POST['tout']=="oui"){?>
...
$a=$b=$c=$d=$e=0;
					...
					while ($data2 = mysqli_fetch_assoc($req2)){
						...
						if($i.$data2['id']!=$yearnow.$monthnow){?>
								<div class="divTableRow">
								<div class="divTableCell">
								<a href="https://phoenixliquidation.ca/interne/phoenixsupplies/admin/monthly.php?month=<?echo $data2['id']?>&year=<?echo $i;?>&tout=" target='listing' ><?echo $data2['name'];?> (<?echo $i;?>)</a>		
							</div>
<?if($_POST['tout']=="oui"){?>
