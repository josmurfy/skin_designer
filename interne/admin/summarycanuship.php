...
ANNÉE <?echo $i;
$i=11;?>
<br><br>VENTES PhoenixLiquidation
				...
				$yearnow=date("Y");
				  ...
				  for ($i=2018;$i<$yearnow+1;$i++){
					  ...
					  if($init==0){?>
							...
							<div class="divTableRow">
							<div class="divTableCell">Novembre (<?echo $i-1;?>)</div>
<?if($_POST['tout']=="oui"){?>
...
<?$a=$b=$c=$d=$e=0;?>
							<div class="divTableRow">
							<div class="divTableCell">Décembre (<?echo $i-1;?>)</div>
<?if($_POST['tout']=="oui"){?>
...
$a=$b=$c=$d=$e=0;
					...
					while ($data2 = mysqli_fetch_assoc($req2)){
						...
						if($i.$data2['id']!=$yearnow.$monthnow){?>
								<div class="divTableRow">
								<div class="divTableCell"><?echo $data2['name'];?> (<?echo $i;?>)</div>
<?if($_POST['tout']=="oui"){?>
