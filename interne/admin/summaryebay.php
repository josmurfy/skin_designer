...
<h1>Sommaire par année</h1>
                  <select name="year" id="input-year" class="form-control">
                    ...
                    <option value="2022" <?php if ($_POST['year'] == 2022) { ?>selected="selected"<?}?>>2022</option> 
                    <option value="2023" <?php if ($_POST['year'] == 2023) { ?>selected="selected"<?}?>>2023</option> 
                    <option value="2024" <?php if ($_POST['year'] == 2024) { ?>selected="selected"<?}?>>2024</option> 
                 </select>
