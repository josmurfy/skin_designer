...
<body bgcolor="ffffff">
<form id="form_67341" class="appnitro" action="importation_square.php" method="post" enctype="multipart/form-data">
<div class="form_description">
Importation de SQUARE<br>
