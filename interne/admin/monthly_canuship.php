...
<body bgcolor="ffffff">
<form id="form_67341" class="appnitro" action="monthly_canuship.php?month=<?echo $_POST['month'];?>&year=<?echo $_POST['year']?>&tout=<?echo $_GET['tout']?>" method="post" enctype="multipart/form-data">
...
<?
$datas=get_transaction($_POST['year'],$_POST['year'],$_POST['month'],$_POST['month'],"canuship_sales","currency='USD' AND ",$db);
...
?>
<br><br>
Ventes SITEWEB avec Paypal USD
...
<div class="divTableHead">Frais Paypal(CAD)</div>
...
<div class="divTableCell"><?if($data['currency']=="CAD"){echo "$ ".number_format($data['net']/1.34,2);}else{echo "$ ".number_format($data['net'],2);}?></div>
<div class="divTableCell"><?if($data['currency']=="CAD"){echo "$ ".number_format($data['fee'],2);}else{echo "$ ".number_format($data['fee']*$rate,2);}?></div>
<div class="divTableCell"><?if($data['currency']=="CAD")echo "$ ".number_format($data['sales_taxes'],2);?></div>
...
if($data['currency']=="CAD"){$sales=$sales+$data['net']/1.34;}else{$sales=$sales+$data['net'];}
if($data['currency']=="CAD"){$fee=$fee+($data['fee']);}else{$fee=$fee+($data['fee']*$rate);}
if($data['country']=="CA")$taxes=$taxes+($data['sales_taxes']);

if($data['state_province']=="QC")$txqc=$txqc+($data['sales_taxes']);
if($data['state_province']=="ON")$txon=$txon+($data['sales_taxes']);
if($data['state_province']=="BC")$txbc=$txbc+($data['sales_taxes']);
if($data['state_province']=="AB")$txab=$txab+($data['sales_taxes']);
if($data['state_province']=="SK")$txsk=$txsk+($data['sales_taxes']);
if($data['state_province']=="MB")$txmb=$txmb+($data['sales_taxes']);
if($data['state_province']=="NS")$txns=$txns+($data['sales_taxes']);
if($data['state_province']=="NB")$txnb=$txnb+($data['sales_taxes']);
if($data['state_province']=="NL")$txnl=$txnl+($data['sales_taxes']);
if($data['state_province']=="YK")$txyk=$txyk+($data['sales_taxes']);
if($data['state_province']=="PEI")$txpei=$txpei+($data['sales_taxes']);
if($data['state_province']=="NWT")$txnwt=$txnwt+($data['sales_taxes']);
}?>
<div class="divTableRow">
...
<div class="divTableCell" style="background-color:green; color: white;"><?echo "$ ".number_format($fee,2);?> CAD</div>
...
<?
$datas=get_transaction($_POST['year'],$_POST['year'],$_POST['month'],$_POST['month'],"canuship_sales","currency='CAD' AND ",$db);
//print("<pre>".print_r ($datas,true )."</pre>");
$sales=0;
$fee=0;
$taxes=0;
...
?>
<br><br>
Services CANUSHIP avec Paypal en CAD
<div class="divTable blueTable">
<div class="divTableHeading">
<div class="divTableRow">
<div class="divTableHead">Date</div>
<div class="divTableHead">Client</div>
<div class="divTableHead">Devise</div>
<div class="divTableHead">Vente Net(CAD)</div>
<div class="divTableHead">Frais Paypal(CAD)</div>
<div class="divTableHead">Taxes</div>
<div class="divTableHead">Province</div>
</div>
...
<div class="divTableCell"><?echo $data['name'];?></div>
<div class="divTableCell"><?echo $data['currency'];?></div>
<div class="divTableCell"><?if($data['currency']=="CAD"){echo "$ ".number_format($data['net'],2);}else{echo "$ ".number_format($data['net'],2);}?></div>
...
if($data['currency']=="CAD"){$sales=$sales+$data['net'];}else{$sales=$sales+$data['net'];}
if($data['currency']=="CAD"){$fee=$fee+($data['fee']);}else{$fee=$fee+($data['fee']);}
if($data['country']=="CA")$taxes=$taxes+($data['sales_taxes']);
...
<?
$datas=get_transaction($_POST['year'],$_POST['year'],$_POST['month'],$_POST['month'],"website_refunds","",$db);
//print("<pre>".print_r ($datas,true )."</pre>");
$sales=0;
$fee=0;
$taxes=0;
...
<?
$datas=get_website_transaction($_POST['year'],$_POST['year'],$_POST['month'],$_POST['month'],"currency_code='USD' AND ",$db);
//print("<pre>".print_r ($datas,true )."</pre>");
//echo count($datas);
$sales=0;
$sales_elavon=0;
...
<div class="divTableCell"><?echo "$ ".number_format($data['total']['value'],2);?></div>
<div class="divTableCell"><?echo "$ ".number_format($data['tax']['value'],2);?></div>
<div class="divTableCell"><?echo $data['payment_zone'];?></div>
...
if($data['payment_code']=="stripe")$sales_stripe+=$data['total']['value'];
...
<div class="divTableCell"></div>
<div class="divTableCell" style="color: red" ><?echo "$ ".number_format($sales,2);?> USD</div>
<div class="divTableCell" style="color: red"><?echo "$ ".number_format($taxes,2);?> USD</div>
<div class="divTableCell"></div>
...
Ventes par Methode de payment SITEWEB USD
<div class="divTable blueTable">
<div class="divTableHeading">
<div class="divTableRow">
...
<div class="divTableBody">
<div class="divTableRow">
<div class="divTableCell"<?if($sales_paypal>0){echo 'style="background-color:green; color: white;"';}?>><?echo "$ ".number_format($sales_paypal,2);?> USD</div>
<div class="divTableCell"<?if($sales_elavon>0){echo 'style="background-color:green; color: white;"';}?>><?echo "$ ".number_format($sales_elavon,2);?> USD</div>
<div class="divTableCell"<?if($sales_square>0){echo 'style="background-color:green; color: white;"';}?>><?echo "$ ".number_format($sales_square,2);?> USD</div>
<div class="divTableCell"<?if($sales_stripe>0){echo 'style="background-color:green; color: white;"';}?>><?echo "$ ".number_format($sales_stripe,2);?> USD</div>
...
<?
mysqli_close($db); 
$db = mysqli_connect('127.0.0.1','n7f9655_n7f9655','jnthngrvs01$$','n7f9655_canuship');
...
if($data['payment_code']=="Debit" || $data['payment_code']=="Débit")$sales_debit+=$data['total']['value']*1.34;
