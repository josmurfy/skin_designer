...
<body>
    ...
    <script src="https://github.com/niklasvh/html2canvas/releases/download/v1.0.0-rc.5/html2canvas.min.js" type="text/javascript"></script>
        ...
        $("#printBtn").click(function () {
            ...
            html2canvas(document.getElementById('card'), { scale: 5 }).then(function (canvas) {
                ...
                $.ajax({
                    ...
                    data: { base64ImageContent : imgBase64Content},
