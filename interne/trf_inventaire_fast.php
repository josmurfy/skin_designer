...
//print("<pre>".print_r ($_POST,true )."</pre>");
    ...
    if ((isset($_POST['new_loc']) && $_POST['new_loc']!=""))
    {
                ...
                echo '<script>window.open("https://phoenixliquidation.ca/interne/phoenixsupplies/trf_inventaire_fast.php?new_loc='.$_POST['new_loc'].'&anc_loc='.$_POST['anc_loc'].'","location")</script>';
                unset($_POST);
