...
if (isset($_POST['ebay_item_id']) && $_POST['new']==1){
	if($_POST['quantitysold']==0)
	{
		...
		$sql2 = 'UPDATE `oc_product` SET quantity=quantity-'.$_POST['quantitysold'].',ebay_last_check="2020-09-01", location ="'.$_POST['location'].'" where product_id='.$_POST['product_id'];
		//echo $sql2.'<br><br>';
...
<body bgcolor="a8c6fe">
<form id="form_67341" class="appnitro" action="vente.php" method="post">
<div class="form_description">
<h1>Vente Item</h1>
</div>
<h3>SKU ou nu produit <input id="ebay_item_id" class="element text medium" style="font-size: 13px; font-weight: normal;" type="text" name="ebay_item_id" value="<?echo $data['ebay_item_id'];?>" maxlength="255" /></h3>
