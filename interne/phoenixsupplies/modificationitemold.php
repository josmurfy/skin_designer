...
if ($_POST['name_product']!="" && $_POST['sku']!="" && $_POST['new']==1){
		...
		$sql2 = 'UPDATE `oc_product` SET `inventaire`=1, `invoice`="'.$_POST['invoice'].'",`model`="'.strtoupper($_POST['model']).'",`color`="'.strtoupper($_POST['color']).'", `upc`=""';
		...
		$sql2 .=', `weight`="'.$weight.'",`height`="'.$_POST['height'].'", condition_id="'.$_POST['etat'].'"';
		...
		$sql2 = 'UPDATE `oc_product` SET `weight`="'.$weight.'",`height`="'.$_POST['height'].'"';
...
if (isset($_POST['category_id']) && $_POST['category_id']!=""){
			...
			$sql = 'SELECT * FROM `oc_category`,`oc_category_description` where oc_category.category_id=oc_category_description.category_id and language_id=1 and oc_category.category_id='.$_POST['category_id'];
			//echo $sql;
...
// modification toutjours de description
			...
			header("location: pretlister.php?sku=".$_POST['sku']."&product_id=".$_POST['product_id']."&action=interne"); 
			}
		$new=1;
}
if (isset($_POST['sku']) && $_POST['sku']!=""){
			...
			//echo $_POST['sku'];
			$sql = 'SELECT * FROM `oc_product`,`oc_product_description` where oc_product.product_id=oc_product_description.product_id and (sku = "'.$_POST['sku'].'" or oc_product.product_id="'.$_POST['sku'].'")';
	//echo $sql;
			$req = mysqli_query($db,$sql);
			$data = mysqli_fetch_assoc($req);
...
<form id="form_67341" class="appnitro" action="modificationitem.php" method="post">
...
<input id="price" type="text" name="price" value="<?echo $_POST['price'];?>" size="10" /></h3></td>
	...
	<table width="100%">
	  <tr>
		...
		<td><input id="length" class="" type="text" name="length" value="<?echo intval($_POST['length']);?>" maxlength="5" /></td>
		<td><b>L</b></td>
		<td><input id="width" class="" type="text" name="width" value="<?echo intval($_POST['width']);?>" maxlength="5" /></td>
		<td><b>P</b></td>		
		<td><input id="height" class="" type="text" name="height" value="<?echo intval($_POST['height']);?>" maxlength="5" /></td>
		<td><b>H</b></td>	
		<td> </td>
		<td> </td>		
	  </tr>
	  <tr>
		...
		<td><b>Lbs</b></td>
		<td><input id="weight2" class="" type="text" name="weight2" value="<?echo $_POST['weight2'];?>" maxlength="5" /> </td>
		<td><b>Oz</b></td>
		<td> </td>
		<td> </td>
		<td> </td>
