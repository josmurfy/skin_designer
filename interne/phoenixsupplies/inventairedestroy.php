...
//echo $sql;
		...
		$data[quantityrecu]--;
		$data[quantitydetruit]++;
		$sql2 = 'UPDATE `oc_product_reception` SET quantitydetruit="'.$data[quantitydetruit].'" where upc = "'.$_POST['upc'].'" and invoice="'.$_POST[invoice].'"';
		//echo $sql2.'<br><br>';
...
<form id="form_67341" class="appnitro" action="inventairedestroy.php" method="post">
