...
if($_POST['catnameen']!="" && $_POST['catnamefr']!="" && $_POST['numcat']!="" && $_POST['parent_id']!="" ){
	...
	$sql = "INSERT INTO `oc_category` (`category_id_index`, `category_id`, `image`, `parent_id`, `top`, `column`, `sort_order`, `status`, `date_added`, `date_modified`, `dotmed_category_id`,  `verif`) VALUES (NULL, '".$_POST['numcat']."', NULL, '".$_POST['parent_id']."', NULL, NULL, '0', '0', NULL, NULL,  NULL, '1')";
	echo $sql."<br>";
	$req = mysqli_query($db,$sql);
