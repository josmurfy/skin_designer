...
if($_POST['sku']=="" && !isset($_POST['sku'])){
    ...
    $_POST['nameen']="National Geographic";
    ...
    $_POST['weight2']="12";
        ...
        $_POST['category_id']=280;
  $_POST['manufacturer_id']=1270;
...
//echo "allo-->";
	...
	if((!isset($_POST['product_id']) || $_POST['product_id']=="" || $_POST['product_id']==0) && count($_POST)>4){
	//	echo count($_POST);
...
$etat=explode(",",$_POST['etat']);
		...
		if(isset($_POST['clone'])&&$_POST['clone']!=""&&$_POST['action']!='listing'){
			$_POST['sku']=substr((string)$_POST['sku'] ,0,12).$etat[1]."_".$_POST['clone'];
...
<form action="insertionitem_ng.php" method="post">
