...
<body>
	...
	<table style="width: 3.825in;" cellpadding="0" cellspacing="5">
			<tr>
			<td align="center" style="height: 3in;" valign="top">
				<img height="100" src="http://www.phoenixsupplies.ca//image/catalog/cie/entetelow.jpg"/><br><br>
				<svg class="barcode"
					jsbarcode-value="<?echo $data['sku'];?>"
					jsbarcode-textmargin="0"
					jsbarcode-height="50"
					jsbarcode-fontoptions="bold"
					jsbarcode-fontsize="36">
					
				</svg>
				<script>
				JsBarcode(".barcode").init();
				</script><br><br>
				<strong>Product: </strong><br><h3><?echo $data['name'];?></h3><br>
			</td>
			</tr>
			<tr>
				<td align="center" style="height: 3in;" valign="middle">
				<img style="height: 2.75in;" src="http://www.phoenixsupplies.ca/image/<?echo $data['image'];?>"/>
			</td>
			</tr>
	</table>
