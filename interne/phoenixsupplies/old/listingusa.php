...
<form method="post" action="listingusa.php" name="listing">
...
?>
	  ...
	  <tr>
		...
		<a href="insertionitemusa.php?sku=<? echo $sku;?>&action=listingusa"><strong>Ajouter</strong></a> 
...
<table style="text-align: left; width: 1053px; margin-left: auto; margin-right: auto;" border="1" cellpadding="2" cellspacing="2">
  ...
  <tbody>
    ...
    <tr>
      <td colspan="2" rowspan="1" style="vertical-align:  middle; text-align: center; height: 192px; width: 33%;"><?echo $_POST['name']."<br>";?><?echo $imagenew;?>
	 <br><?echo $descriptionn; echo "$ ".number_format($_POST['price'],2);?>
      </td>
	  ...
	  <br><?echo $descriptionno;echo "$ ".number_format($datano['price'],2)?>
      </td>
     ...
     <br><?echo $descriptionr;echo "$ ".number_format($datar['price'],2);?>
	 </td>
    </tr>
    <tr>

      <td style="vertical-align:  middle; font-weight: bold; text-align: center; background-color: rgb(255, 204, 204); height: 0px; width: 16%;">
	  <a href="pretlisterusa.php?product_id=<? echo $_POST['product_id'];?>&action=listingusa"><strong>Pret a Lister</strong></a>
      </td>
      <td style="vertical-align:  middle; font-weight: bold; text-align: center; background-color: rgb(255, 204, 204); height: 0px; width: 16%;">
	 	<a href="listingusa.php?etat=9&sku=<? echo $_POST['sku'];?>&product_id=<? echo $_POST['product_id'];?>&action=default"><strong>Par Default</strong></a></td>

      </td>
      <td style="vertical-align:  middle; font-weight: bold; text-align: center; background-color: rgb(255, 204, 204); height: 0px; width: 16%;">
	  <a href="pretlisterusa.php?product_id=<? echo $datano['product_id'];?>&action=listingusa"><strong>Pret a Lister</strong></a></td>
      <td style="vertical-align:  middle; font-weight: bold; text-align: center; background-color: rgb(255, 204, 204); height: 0px; width: 16%;">
	  <a href="listingusa.php?etat=99&sku=<? echo $datano['sku'];?>&product_id=<? echo $datano['product_id'];?>&action=default"><strong>Par Default</strong></a></td></td>
      <td style="vertical-align:  middle; font-weight: bold; text-align: center; background-color: rgb(255, 204, 204); height: 0px; width: 16%;">
	  <a href="pretlisterusa.php?product_id=<? echo $datar['product_id'];?>&action=listingusa"><strong>Pret a Lister</strong></a></td>
      <td style="vertical-align:  middle; font-weight: bold; text-align: center; background-color: rgb(255, 204, 204); height: 0px; width: 16%;">
	  <a href="listingusa.php?etat=22&sku=<? echo $datar['sku'];?>&product_id=<? echo $datar['product_id'];?>&action=default"><strong>Par Default</strong></a></td>
    </tr>
	    <tr>

      <td style="vertical-align:  middle; font-weight: bold; text-align: center; background-color: rgb(255, 204, 204); height: 0px; width: 16%;">
	  <a  href="modificationitemusa.php?sku=<? echo $_POST['sku'];?>&product_id=<? echo $_POST['product_id'];?>&action=listingusa"><strong>Modifier</strong></a> 
      </td>
      <td style="vertical-align:  middle; font-weight: bold; text-align: center; background-color: rgb(255, 204, 204); height: 0px; width: 16%;">
      ...
      <td style="vertical-align:  middle; font-weight: bold; text-align: center; background-color: rgb(255, 204, 204); height: 0px; width: 16%;">
	  <a  href="modificationitemusa.php?sku=<? echo $datano['sku'];?>&product_id=<? echo $datano['product_id'];?>&action=listingusa"><strong>Modifier</strong></a> 
      <td style="vertical-align:  middle; font-weight: bold; text-align: center; background-color: rgb(255, 204, 204); height: 0px; width: 16%;">
      ...
      <td style="vertical-align:  middle; font-weight: bold; text-align: center; background-color: rgb(255, 204, 204); height: 0px; width: 16%;">
	  <a  href="modificationitemusa.php?sku=<? echo $datar['sku'];?>&product_id=<? echo $datar['product_id'];?>&action=listingusa"><strong>Modifier</strong></a> 
      <td style="vertical-align:  middle; font-weight: bold; text-align: center; background-color: rgb(255, 204, 204); height: 0px; width: 16%;">
	...
	<?for ($j = 0; $j <$i; $j++) {?>
		<td colspan="2" rowspan="1" style="vertical-align:  middle; text-align: center; width: 33%">
			<table style="text-align: left; width: 100%;" border="1" cellpadding="2" cellspacing="2">
				...
				<tr>
				<td colspan="2" rowspan="1" style="vertical-align:  middle; text-align: center;  width: 33%;">
					<?if ($data[$j]['status']==1){echo '<img src="https://www.phoenixsupplies.ca/image/checked.png" width="25">';}else{echo '<img src="https://www.phoenixsupplies.ca/image/checkedd.png" width="25">';}if ($data[$j]['marketplace_item_id']>0){echo '<img src="https://www.phoenixsupplies.ca/image/ebay.png" width="50">';}?>
					 <br><?echo $descriptionn; ?>
					 <br>Price RETAIL : <?echo "$ ".number_format($data[$j]['price'],2);?><?if ($data[$j]['price']==0){echo '<img src="https://www.phoenixsupplies.ca/image/crossed.png" width="10">';}?>
					 <br>Price Ebay : <?echo "$ ".number_format($data[$j]['price_with_shipping'],2);?><?if ($data[$j]['price_with_shipping']==0){echo '<img src="https://www.phoenixsupplies.ca/image/crossed.png" width="10">';}?>
					 <br>Price sur Site : <?echo "$ ".number_format($data[$j]['special'],2);echo "</br>".number_format(($data[$j]['special']/$data[$j]['price']*100),1)."%";?><?if ($data[$j]['special']==0 || ($data[$j]['special']/$data[$j]['price']*100)>75){echo '<img src="https://www.phoenixsupplies.ca/image/crossed.png" width="10">';}?>
				</td>
				</tr>
				<tr>
				<td style="vertical-align:  middle; font-weight: bold; text-align: center; background-color: rgb(255, 204, 204); height: 0px; width: 16%;">
					<a href="pretlisterusa.php?product_id=<? echo $datatab[$j]['product_id'];?>&action=listingusa"><strong>Pret a Lister</strong></a>
				</td>
				<td style="vertical-align:  middle; font-weight: bold; text-align: center; background-color: rgb(255, 204, 204); height: 0px; width: 16%;">
					<a  href="modificationitemusa.php?sku=<? echo $datatab[$j]['sku'];?>&product_id=<? echo $datatab[$j]['product_id'];?>&action=listingusa"><strong>Modifier</strong></a> 
				</td>
				</tr>
				<tr>
