...
<h3>SKU <?if($new==1){?><a href="modificationitemusa.php" class="button--style-red">Changer d'item</a><?}?> <a href="interneusa.php" class="button--style-red">Retour au MENU</a></h3>
...
window.open("https://algopix.com/search?query=<?echo substr ($_POST['sku'],0,12);?>&markets=AMAZON_US,EBAY_US,WALMART_US&from=US&shipping_method=carrier&costNew=<?echo $data8[pricecost];?>&costCurrencyCode=USD&itemConditions=<?echo $algoetat;?>&cost<?echo $algoetat;?>=<?echo $data8[pricecost];?>","algopix");
</script>
<?
if($picexterne!="")
{
