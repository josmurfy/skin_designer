...
if ($_POST['name_product']!="" && $_POST['model']!="" && $_POST['manufacturer']!="" && $_POST['new']==1){
		$sql2 = 'UPDATE `oc_product` SET stock_status_id=7,`inventaire`=1, status="'.$_POST['status'].'", price="'.$_POST['price'].'",`remarque_interne`="'.$_POST['remarque'];
...
if($_POST['etat']=="8")$differentiel=.6;
	  		...
	  		$sql9 = 'SELECT * FROM `oc_product_analyse` where upc="'.substr ($_POST['upc'],0,12).'" group by upc';
			//echo $sql9;
