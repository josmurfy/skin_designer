...
if ($_POST['sku']!="" && $_POST['product_id']>0){
...
/* 	if($_POST['etat']!=$_POST['etatavant']){
	...
	//echo $sql;
		...
		$sql2 = 'UPDATE `oc_product` SET `model`="'.strtoupper($_POST['model']).'",`color`="'.strtoupper($_POST['color']).'", `upc`="'.substr($_POST['sku'],0,12).'"';
...
<form id="form_67341" class="appnitro" action="modificationitemusa.php?action=<?echo $_GET['action'];?>" method="post">
...
<a href="<?echo $_GET['action'];?>.php?sku=<?echo $_POST['sku']?>&action=<?echo $default;?>&etat=<?echo $_POST['etat'];?>&product_id=<?echo $_POST['product_id']?>" class="button--style-red">Menu Listing</a></h3>
