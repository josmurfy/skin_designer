...
if (isset($_POST['sku']) && $_POST['sku']!=""){
	...
	//echo $sql;
			...
			pr.product_id=ca.product_id and pr.quantity>0 and pr.usa=1  and  pr.status=0 and not(pr.location="") and pr.remarque_interne="" group by upc order by pr.price desc  '; //and (pr.location like "%magasin%") 
			$req = mysql_query($sql);
...
<form method="post" action="listingusaADMIN.php" name="listing">
