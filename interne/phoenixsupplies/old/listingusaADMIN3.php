...
if (isset($_POST['sku']) && $_POST['sku']!=""){
	...
	//echo $sql;
			...
			pr.product_id=ca.product_id and pr.quantity>0 and pr.usa=1  and  pr.status=0 and not(pr.location="") and pr.remarque_interne="" and (pr.location like "%+ Magasin%") group by upc order by pr.price desc  '; //and (pr.location like "%magasin%") 
			$req = mysql_query($sql);
			echo mysql_num_rows($req);
			
			$sql = 'SELECT * FROM `oc_product` as pr,`oc_product_description` as ds,oc_product_to_category as ca where pr.product_id=ds.product_id and 
			pr.product_id=ca.product_id and pr.quantity>0 and pr.usa=1  and  pr.status=0 and not(pr.location="") and pr.remarque_interne="" order by pr.price desc limit 1 '; //and (pr.location like "%magasin%") 
}
			$req = mysql_query($sql);
...
<html><head>
  ...
  <title>listingusaADMIN3.php</title>
...
<form method="post" action="listingusaADMIN3.php" name="listing">
  ...
  <table style="text-align: left; width: 1053px; height: 100%; margin-left: auto; margin-right: auto;" border="1" cellpadding="2" cellspacing="2">
    ...
    <tbody>
      ...
      <tr>
        <td style="vertical-align: middle; background-color: rgb(255, 204, 204); font-weight: bold; text-align: center;"><h3><?if($new==1){?><a href="listingusaADMIN3.php" class="button--style-red">Changer d'item</a><?}?> <a href="menulisting.php" class="button--style-red">Retour au MENU</a> 		<?if($new==1){?>
...
<table style="text-align: left; width: 1053px; margin-left: auto; margin-right: auto;" border="1" cellpadding="2" cellspacing="2">
  <tbody>
    ...
    <tr>
      ...
      <td style="vertical-align:  middle; font-weight: bold; text-align: center; background-color: rgb(255, 204, 204); height: 0px; width: 16%;">
	 	<a href="listingusaADMIN3.php?etat=9&sku=<? echo $_POST['sku'];?>&product_id=<? echo $_POST['product_id'];?>&action=default"><strong>Par Default</strong></a></td>

      </td>
      <td style="vertical-align:  middle; font-weight: bold; text-align: center; background-color: rgb(255, 204, 204); height: 0px; width: 16%;">
	  <a href="pretlisterusaADMIN.php?product_id=<? echo $datano['product_id'];?>&action=listingusaADMIN"><strong>Pret a Lister</strong></a></td>
      <td style="vertical-align:  middle; font-weight: bold; text-align: center; background-color: rgb(255, 204, 204); height: 0px; width: 16%;">
	  <a href="listingusaADMIN3.php?etat=99&sku=<? echo $datano['sku'];?>&product_id=<? echo $datano['product_id'];?>&action=default"><strong>Par Default</strong></a></td></td>
      <td style="vertical-align:  middle; font-weight: bold; text-align: center; background-color: rgb(255, 204, 204); height: 0px; width: 16%;">
	  <a href="pretlisterusaADMIN.php?product_id=<? echo $datar['product_id'];?>&action=listingusaADMIN"><strong>Pret a Lister</strong></a></td>
      <td style="vertical-align:  middle; font-weight: bold; text-align: center; background-color: rgb(255, 204, 204); height: 0px; width: 16%;">
	  <a href="listingusaADMIN3.php?etat=22&sku=<? echo $datar['sku'];?>&product_id=<? echo $datar['product_id'];?>&action=default"><strong>Par Default</strong></a></td>
    </tr>
	    <tr>
      ...
      <td style="vertical-align:  middle; font-weight: bold; text-align: center; background-color: rgb(255, 204, 204); height: 0px; width: 16%;">
	 	<a href="createbarcodemagasinun.php?sku=<? echo $_POST['sku'];?>&product_id=<? echo $_POST['product_id'];?>&action=modificationitemusa" target="label" ><strong>Etiquette Prix</strong></a></td>
      ...
      <td style="vertical-align:  middle; font-weight: bold; text-align: center; background-color: rgb(255, 204, 204); height: 0px; width: 16%;">
	  <a href="createbarcodemagasinun.php?sku=<? echo $datano['sku'];?>&product_id=<? echo $datano['product_id'];?>&action=modificationitemusa" target="label" ><strong>Etiquette Prix</strong></a></td></td>
      <td style="vertical-align:  middle; font-weight: bold; text-align: center; background-color: rgb(255, 204, 204); height: 0px; width: 16%;">
      ...
      <td style="vertical-align:  middle; font-weight: bold; text-align: center; background-color: rgb(255, 204, 204); height: 0px; width: 16%;">
	  <a href="createbarcodemagasinun.php?sku=<? echo $datar['sku'];?>&product_id=<? echo $datar['product_id'];?>&action=modificationitemusa" target="label" ><strong>Etiquette Prix</strong></a></td>
    </tr>
    <tr>
