...
OR `admin_paypal`.`type_transaction`='Reversal of General Account Hold' OR `admin_paypal`.`type_transaction`='Postage Payment' OR `admin_paypal`.`type_transaction`='General Authorization' OR `admin_paypal`.`type_transaction`='Hold on Balance for Dispute Investigation' OR `admin_paypal`.`type_transaction`='Account Hold for Open Authorization' OR `admin_paypal`.`balance_impact`like '%Memo%' OR `admin_paypal`.`type_transaction`='General Incentive/Certificate Redemption')";
...
$j=0;
$sql2 = 'SELECT * FROM `admin_paypal` WHERE (type_transaction="Bank Deposit to PP Account") AND type_transaction_ok=0 order by date_transaction';
...
while ($data2 = mysqli_fetch_assoc($req2)){
					...
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); 
					$mysqlierr=mysqli_error($req);if($mysqlierr!="")echo $mysqlierr."<br>";if($mysqlierr==""){$sql = 'UPDATE `admin_paypal` SET to_table="admin_deposits",type_transaction_ok=1 WHERE admin_paypal_id="'.$data2['admin_paypal_id'].'"';
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); }
					$j++;
}
...
$sql2 = 'SELECT * FROM `admin_paypal` WHERE (type_transaction="eBay Auction Payment") AND type_transaction_ok=0 order by date_transaction';
$req2 = mysqli_query($db,$sql2); 
//echo $sql2."<br>";
while ($data2 = mysqli_fetch_assoc($req2)){
		if($data2['item_title']=="eBay Seller Fee"){
			$sql = 'INSERT INTO `admin_ebay_fee` (`admin_paypal_id`, `date_transaction`, `timezone`, `status`';
					...
					$sql = $sql.'VALUES ( "'.$data2['admin_paypal_id'].'", "'.$data2['date_transaction'].'", "'.$data2['timezone'].'"';
					$sql = $sql.', "'.$data2['status'].'", "'.$data2['currency'].'", "'.$data2['gross'].'", "'.$data2['name'].'")';
					
					//echo $data2[0]."<br>";	
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); 
					$mysqlierr=mysqli_error($req);if($mysqlierr!="")echo $mysqlierr."<br>";if($mysqlierr==""){$sql = 'UPDATE `admin_paypal` SET to_table="admin_ebay_fee",type_transaction_ok=2,fee_ok=2 WHERE admin_paypal_id="'.$data2['admin_paypal_id'].'"';
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); }
					...
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); 
					$mysqlierr=mysqli_error($req);if($mysqlierr!="")echo $mysqlierr."<br>";if($mysqlierr==""){$sql = 'UPDATE `admin_paypal` SET to_table="admin_purchases_paypal",type_transaction_ok=2,fee_ok=2 WHERE admin_paypal_id="'.$data2['admin_paypal_id'].'"';
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); }
...
//ajout Taxes CANADA
				if($data2['sales_taxes']>0){
					...
					if($data2['country']=="CA"){
									...
									//echo $sql."<br>";
									$req = mysqli_query($db,$sql); 
									$mysqlierr=mysqli_error($req);if($mysqlierr!="")echo $mysqlierr."<br>";if($mysqlierr==""){$sql = 'UPDATE `admin_paypal` SET sales_taxes_ok=2 WHERE admin_paypal_id="'.$data2['admin_paypal_id'].'"';
									//echo $sql."<br>";
									$req = mysqli_query($db,$sql); }
					...
					$sql = $sql.'VALUES ( "'.$data2['admin_paypal_id'].'", "'.$data2['date_transaction'].'", "'.$data2['timezone'].'"';
					$sql = $sql.', "'.$data2['status'].'", "'.$data2['currency'].'", "'.$data2['fee'].'", "'.$data2['name'].'","eBay")';
					//echo $data2[0]."<br>";	
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); 
					$mysqlierr=mysqli_error($req);if($mysqlierr!="")echo $mysqlierr."<br>";if($mysqlierr==""){$sql = 'UPDATE `admin_paypal` SET to_table="admin_ebay_sales",type_transaction_ok=2,fee_ok=2 WHERE admin_paypal_id="'.$data2['admin_paypal_id'].'"';
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); }
...
$sql2 = 'SELECT * FROM `admin_paypal` WHERE name like "%eBay%Canada%Limited%" AND type_transaction_ok=0 order by date_transaction';
$req2 = mysqli_query($db,$sql2); 
while ($data2 = mysqli_fetch_assoc($req2)){
					...
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); 
					$mysqlierr=mysqli_error($req);if($mysqlierr!="")echo $mysqlierr."<br>";if($mysqlierr==""){$sql = 'UPDATE `admin_paypal` SET to_table="admin_ebay_fee",type_transaction_ok=3 WHERE admin_paypal_id="'.$data2['admin_paypal_id'].'"';
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); }
					$j++;
}
...
while ($data2 = mysqli_fetch_assoc($req2)){
					...
					$sql = $sql.', `item_id`, `item_title`, `quantity`, `gross`, `net`, `shipping_handling`';
					$sql = $sql.', `currency`, `balance_impact`, `name`, `shipping_address`, `state_province`) ';
					$sql = $sql.'VALUES ( "'.$data2['admin_paypal_id'].'", "'.$data2['date_transaction'].'", "'.$data2['timezone'].'"';
					$sql = $sql.', "'.$data2['status'].'", "'.$data2['item_id'].'", "'.$data2['item_title'].'"';
					$sql = $sql.', "'.$data2['quantity'].'", "'.$data2['gross'].'", "'.($data2['net']-$data2['sales_taxes']).'","'.$data2['shipping_handling'].'"';
					$sql= $sql.', "'.$data2['currency'].'", "'.$data2['balance_impact'].'", "'.$data2['name'].'"';
					$sql= $sql.', "'.$data2['shipping_address'].'", "'.$data2['state_province'].'")';
					$req = mysqli_query($db,$sql); 
					$sql = 'INSERT INTO `admin_paypal_fee` (`admin_paypal_id`, `date_transaction`, `timezone`, `status`';
					$sql = $sql.', `currency`, `net`, `name`,`from_order`) ';
					$sql = $sql.'VALUES ( "'.$data2['admin_paypal_id'].'", "'.$data2['date_transaction'].'", "'.$data2['timezone'].'"';
					$sql = $sql.', "'.$data2['status'].'", "'.$data2['currency'].'", "'.$data2['fee'].'", "'.$data2['name'].'","Bonanza")';
					
					//echo $data2[0]."<br>";	
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); 
					$mysqlierr=mysqli_error($req);if($mysqlierr!="")echo $mysqlierr."<br>";if($mysqlierr==""){$sql = 'UPDATE `admin_paypal` SET to_table="admin_bonanza_sales",type_transaction_ok=4,fee_ok=4 WHERE admin_paypal_id="'.$data2['admin_paypal_id'].'"';
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); }
					$j++;
}
...
while ($data2 = mysqli_fetch_assoc($req2)){
					...
					if($data2['fee']<>0){
						...
						$sql = $sql.', `currency`, `net``, `name`,`from_order`) ';
						$sql = $sql.'VALUES ( "'.$data2['admin_paypal_id'].'", "'.$data2['date_transaction'].'", "'.$data2['timezone'].'"';
						$sql = $sql.', "'.$data2['status'].'", "'.$data2['currency'].'", "'.$data2['fee'].'", "'.$data2['name'].'","Invoice")';
						//echo $data2[0]."<br>";	
						//echo $sql."<br>";
						$req = mysqli_query($db,$sql); 
					}
					$mysqlierr=mysqli_error($req);if($mysqlierr!="")echo $mysqlierr."<br>";if($mysqlierr==""){$sql = 'UPDATE `admin_paypal` SET to_table="admin_invoice_sales",type_transaction_ok=5,fee_ok=5 WHERE admin_paypal_id="'.$data2['admin_paypal_id'].'"';
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); }
					$j++;
}
...
while ($data2 = mysqli_fetch_assoc($req2)){
					...
					$sql = $sql.', `item_id`, `item_title`, `quantity`, `gross`, `net`,`sales_taxes`, `shipping_handling`';
					$sql = $sql.', `currency`, `balance_impact`, `name`, `shipping_address`, `state_province`, `from_email`) ';
					$sql = $sql.'VALUES ( "'.$data2['admin_paypal_id'].'", "'.$data2['date_transaction'].'", "'.$data2['timezone'].'"';
					$sql = $sql.', "'.$data2['status'].'", "'.$data2['item_id'].'", "'.$data2['item_title'].'"';
					$sql = $sql.', "'.$data2['quantity'].'", "'.$data2['gross'].'", "'.($data2['net']-$data2['sales_taxes']).'","'.$data2['sales_taxes'].'","'.$data2['shipping_handling'].'"';
					$sql= $sql.', "'.$data2['currency'].'", "'.$data2['balance_impact'].'", "'.$data2['name'].'"';
					$sql= $sql.', "'.$data2['shipping_address'].'", "'.$data2['state_province'].'", "'.$data2['from_email'].'")';
					$req = mysqli_query($db,$sql); 
					$sql = 'INSERT INTO `admin_paypal_fee` (`admin_paypal_id`, `date_transaction`, `timezone`, `status`';
					$sql = $sql.', `currency`, `net`, `name`,`from_order`) ';
					$sql = $sql.'VALUES ( "'.$data2['admin_paypal_id'].'", "'.$data2['date_transaction'].'", "'.$data2['timezone'].'"';
					$sql = $sql.', "'.$data2['status'].'", "'.$data2['currency'].'", "'.$data2['fee'].'", "'.$data2['name'].'","Website")';
					//echo $data2[0]."<br>";	
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); 
					$mysqlierr=mysqli_error($req);if($mysqlierr!="")echo $mysqlierr."<br>";if($mysqlierr==""){$sql = 'UPDATE `admin_paypal` SET to_table="admin_website_sales",type_transaction_ok=6,fee_ok=6 WHERE admin_paypal_id="'.$data2['admin_paypal_id'].'"';
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); }
					$j++;
}
...
$j=0;
$sql2 = 'SELECT * FROM `admin_paypal` WHERE type_transaction="General Payment" AND to_email="gervais.jonathan@phoenixsupplies.ca" AND type_transaction_ok=0 order by date_transaction';
$req2 = mysqli_query($db,$sql2); 
while ($data2 = mysqli_fetch_assoc($req2)){
					$sql = 'INSERT INTO `admin_website_sales` (`admin_paypal_id`, `date_transaction`, `timezone`, `status`';
					$sql = $sql.', `item_id`, `item_title`, `quantity`, `gross`, `net`,`sales_taxes`, `shipping_handling`';
					...
					$sql = $sql.', `currency`, `net`, `name`,`from_order`) ';
					$sql = $sql.'VALUES ( "'.$data2['admin_paypal_id'].'", "'.$data2['date_transaction'].'", "'.$data2['timezone'].'"';
					$sql = $sql.', "'.$data2['status'].'", "'.$data2['currency'].'", "'.$data2['fee'].'", "'.$data2['name'].'","Website2")';
					//echo $data2[0]."<br>";	
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); 
					$mysqlierr=mysqli_error($req);if($mysqlierr!="")echo $mysqlierr."<br>";if($mysqlierr==""){$sql = 'UPDATE `admin_paypal` SET to_table="admin_website_sales",type_transaction_ok=7,fee_ok=7 WHERE admin_paypal_id="'.$data2['admin_paypal_id'].'"';
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); }
					$j++;
}
...
$j=0;
//ajout Refund
$sql2 = 'SELECT * FROM `admin_paypal` WHERE (type_transaction="Payment Refund" OR type_transaction="Payment Reversal" OR type_transaction="Third Party Recoupment")AND type_transaction_ok=0 order by date_transaction';
$req2 = mysqli_query($db,$sql2); 
while ($data2 = mysqli_fetch_assoc($req2)){
	if($data2['name']=="eBay Inc Shipping"){
		$sql = 'INSERT INTO `admin_shipping` (`admin_paypal_id`, `date_transaction`, `timezone`, `status`';
					...
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); 
					$mysqlierr=mysqli_error($req);if($mysqlierr!="")echo $mysqlierr."<br>";if($mysqlierr==""){$sql = 'UPDATE `admin_paypal` SET to_table="admin_shipping",type_transaction_ok=8,fee_ok=8  WHERE admin_paypal_id="'.$data2['admin_paypal_id'].'"';
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); }
					$j++;
	}elseif($data2['balance_impact']=="Debit" && (strlen($data2['item_id'])==12 || $data2['type_transaction']=="Third Party Recoupment")){
		$sql ='SELECT * FROM `admin_paypal` WHERE (`name`="'.$data2['name'].'" OR `item_id`= "'.$data2['item_id'].'" )AND balance_impact="CREDIT"';
		$req = mysqli_query($db,$sql); 
		echo $sql."<br>";
		$data = mysqli_fetch_assoc($req);
		
		if($data2['sales_taxes']>0 || $data['country']=="CA" ){
					if(strtolower($data['state_province'])=="puerto rico")$data['state_province']="PR";
					if(strtolower($data['state_province'])=="pennsylvania")$data['state_province']="PA";
					if(strtolower($data['state_province'])=="oregon")$data['state_province']="OR";
					if(strtolower($data['state_province'])=="ontario")$data['state_province']="ON";
					if(strtolower($data['state_province'])=="oklahoma")$data['state_province']="OK";
					if(strtolower($data['state_province'])=="nova scotia")$data['state_province']="NS";
					if(strtolower($data['state_province'])=="north carolina")$data['state_province']="NC";
					if(strtolower($data['state_province'])=="newfoundland")$data['state_province']="NL";
					if(strtolower($data['state_province'])=="new york")$data['state_province']="NY";
					if(strtolower($data['state_province'])=="new mexico")$data['state_province']="NM";
					if(strtolower($data['state_province'])=="new jersey")$data['state_province']="NJ";
					if(strtolower($data['state_province'])=="missouri (mo)")$data['state_province']="MO";
					if(strtolower($data['state_province'])=="missouri")$data['state_province']="MO";
					if(strtolower($data['state_province'])=="mississippi")$data['state_province']="MS";
					if(strtolower($data['state_province'])=="michigan")$data['state_province']="MI";
					if(strtolower($data['state_province'])=="minnesota")$data['state_province']="MN";
					if(strtolower($data['state_province'])=="manitoba")$data['state_province']="MB";
					if(strtolower($data['state_province'])=="louisiana")$data['state_province']="LA";
					if(strtolower($data['state_province'])=="kentucky")$data['state_province']="KY";
					if(strtolower($data['state_province'])=="kansas")$data['state_province']="KS";
					if(strtolower($data['state_province'])=="indiana")$data['state_province']="IN";
					if(strtolower($data['state_province'])=="illinois")$data['state_province']="IL";
					if(strtolower($data['state_province'])=="guam")$data['state_province']="GU";
					if(strtolower($data['state_province'])=="georgia")$data['state_province']="GA";
					if(strtolower($data['state_province'])=="florida")$data['state_province']="FL";
					if(strtolower($data['state_province'])=="colorado")$data['state_province']="CO";
					if(strtolower($data['state_province'])=="california")$data['state_province']="CA";
					if(strtolower($data['state_province'])=="british columbia")$data['state_province']="BC";
					if(strtolower($data['state_province'])=="alberta")$data['state_province']="AB";
					if(strtolower($data['state_province'])=="quebec")$data['state_province']="QC";
					if(strtolower($data['state_province'])=="québec")$data['state_province']="QC";
					if(strtolower($data['state_province'])=="saskatchewan")$data['state_province']="SK";
					
					$data['state_province']=strtoupper($data['state_province']);
					//echo $data2['country'];
					if($data['country']=="CA"){
									...
									$sql = $sql.', `net`, `currency`, `state_province`,`country`, `name`) ';
									$sql = $sql.'VALUES ( "'.$data2['admin_paypal_id'].'", "'.$data2['date_transaction'].'", "'.$data2['timezone'].'"';
									$sql = $sql.', "'.$data2['status'].'", "'.$data2['sales_taxes'].'", "'.$data2['currency'].'", "'.$data['state_province'].'", "'.$data['country'].'", "'.$data['type_transaction'].'")';
					...
					$sql= $sql.', "'.$data2['currency'].'", "'.$data2['balance_impact'].'", "'.$data2['name'].'"';
					$sql= $sql.', "'.$data['shipping_address'].'", "'.$data['state_province'].'", "'.$data['country'].'")';
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); 
					$sql = 'INSERT INTO `admin_paypal_fee` (`admin_paypal_id`, `date_transaction`, `timezone`, `status`';
					$sql = $sql.', `currency`, `net`, `name`,`from_order`) ';
					$sql = $sql.'VALUES ( "'.$data2['admin_paypal_id'].'", "'.$data2['date_transaction'].'", "'.$data2['timezone'].'"';
					$sql = $sql.', "'.$data2['status'].'", "'.$data2['currency'].'", "'.$data2['fee'].'", "'.$data2['name'].'","eBayRefund")';
					//echo $data2[0]."<br>";	
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); 
					$mysqlierr=mysqli_error($req);if($mysqlierr!="")echo $mysqlierr."<br>";if($mysqlierr==""){$sql = 'UPDATE `admin_paypal` SET to_table="admin_ebay_refunds",type_transaction_ok=8,fee_ok=8  WHERE admin_paypal_id="'.$data2['admin_paypal_id'].'"';
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); }
					$j++;
	}
...
$sql2 = 'SELECT * FROM `admin_paypal` WHERE type_transaction="Subscription Payment" AND type_transaction_ok=0 order by date_transaction';
$req2 = mysqli_query($db,$sql2); 
while ($data2 = mysqli_fetch_assoc($req2)){
					...
					//echo $sql."<br>"; 
					$req = mysqli_query($db,$sql); 
					$mysqlierr=mysqli_error($req);if($mysqlierr!="")echo $mysqlierr."<br>";if($mysqlierr==""){$sql = 'UPDATE `admin_paypal` SET to_table="admin_purchases_paypal",type_transaction_ok=9 WHERE admin_paypal_id="'.$data2['admin_paypal_id'].'"';
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql);} 
					$j++;
}
...
while ($data2 = mysqli_fetch_assoc($req2)){
					...
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); 
					$mysqlierr=mysqli_error($req);if($mysqlierr!="")echo $mysqlierr."<br>";if($mysqlierr==""){$sql = 'UPDATE `admin_paypal` SET to_table="admin_purchases_paypal",type_transaction_ok=10 WHERE admin_paypal_id="'.$data2['admin_paypal_id'].'"';
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); }
					$j++;
}
...
while ($data2 = mysqli_fetch_assoc($req2)){
					...
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); 
					$mysqlierr=mysqli_error($req);if($mysqlierr!="")echo $mysqlierr."<br>";if($mysqlierr==""){$sql = 'UPDATE `admin_paypal` SET to_table="admin_purchases_paypal",type_transaction_ok=11 WHERE admin_paypal_id="'.$data2['admin_paypal_id'].'"';
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); }
					$j++;
}
...
while ($data2 = mysqli_fetch_assoc($req2)){
					...
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); 
					$mysqlierr=mysqli_error($req);if($mysqlierr!="")echo $mysqlierr."<br>";if($mysqlierr==""){$sql = 'UPDATE `admin_paypal` SET to_table="admin_purchases_paypal",type_transaction_ok=12 WHERE admin_paypal_id="'.$data2['admin_paypal_id'].'"';
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); }
					$j++;
}
...
while ($data2 = mysqli_fetch_assoc($req2)){
					...
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); 
					$mysqlierr=mysqli_error($req);if($mysqlierr!="")echo $mysqlierr."<br>";if($mysqlierr==""){$sql = 'UPDATE `admin_paypal` SET to_table="admin_purchases_paypal",type_transaction_ok=13 WHERE admin_paypal_id="'.$data2['admin_paypal_id'].'"';
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); }
					$j++;
}
...
while ($data2 = mysqli_fetch_assoc($req2)){
					...
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); 
					$mysqlierr=mysqli_error($req);if($mysqlierr!="")echo $mysqlierr."<br>";if($mysqlierr==""){$sql = 'UPDATE `admin_paypal` SET to_table="admin_purchases_cc",type_transaction_ok=14 WHERE admin_paypal_id="'.$data2['admin_paypal_id'].'"';
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); }
					$j++;
}
...
while ($data2 = mysqli_fetch_assoc($req2)){
					...
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); 
					$mysqlierr=mysqli_error($req);if($mysqlierr!="")echo $mysqlierr."<br>";if($mysqlierr==""){$sql = 'UPDATE `admin_paypal` SET to_table="admin_purchases_cc",type_transaction_ok=15 WHERE admin_paypal_id="'.$data2['admin_paypal_id'].'"';
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); }
					$j++;
}
...
while ($data2 = mysqli_fetch_assoc($req2)){
					...
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); 
					$mysqlierr=mysqli_error($req);if($mysqlierr!="")echo $mysqlierr."<br>";if($mysqlierr==""){$sql = 'UPDATE `admin_paypal` SET to_table="admin_shipping POSTPONY",type_transaction_ok=16 WHERE admin_paypal_id="'.$data2['admin_paypal_id'].'"';
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); }
					$j++;
}
...
while ($data2 = mysqli_fetch_assoc($req2)){
					...
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); 
					$mysqlierr=mysqli_error($req);if($mysqlierr!="")echo $mysqlierr."<br>";if($mysqlierr==""){$sql = 'UPDATE `admin_paypal` SET to_table="admin_shipping SHIPPO",type_transaction_ok=17 WHERE admin_paypal_id="'.$data2['admin_paypal_id'].'"';
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); }
					$j++;
}
...
while ($data2 = mysqli_fetch_assoc($req2)){
					...
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); 
					$mysqlierr=mysqli_error($req);if($mysqlierr!="")echo $mysqlierr."<br>";if($mysqlierr==""){$sql = 'UPDATE `admin_paypal` SET to_table="admin_shipping EBAY",type_transaction_ok=18 WHERE admin_paypal_id="'.$data2['admin_paypal_id'].'"';
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); }
					$j++;
}
...
while ($data2 = mysqli_fetch_assoc($req2)){
					...
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); 
					$mysqlierr=mysqli_error($req);if($mysqlierr!="")echo $mysqlierr."<br>";if($mysqlierr==""){$sql = 'UPDATE `admin_paypal` SET to_table="admin_shipping EBAY",type_transaction_ok=19 WHERE admin_paypal_id="'.$data2['admin_paypal_id'].'"';
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); }
					$j++;
}
...
$req2 = mysqli_query($db,$sql2); 
while ($data2 = mysqli_fetch_assoc($req2)){
					$sql = 'INSERT INTO `admin_bonanza_taxes` (`admin_paypal_id`, `date_transaction`, `timezone`, `status`';
					$sql = $sql.', `net`, `currency`, `state_province`, `country`,`name`) ';
					$sql = $sql.'VALUES ( "'.$data2['admin_paypal_id'].'", "'.$data2['date_transaction'].'", "'.$data2['timezone'].'"';
					...
					//	echo $sql."<br>";
						$req = mysqli_query($db,$sql); 
					//}
					$mysqlierr=mysqli_error($req);if($mysqlierr!="")echo $mysqlierr."<br>";if($mysqlierr==""){$sql = 'UPDATE `admin_paypal` SET to_table="admin_bonanza_taxes",type_transaction_ok=21,sales_taxes_ok=21 WHERE admin_paypal_id="'.$data2['admin_paypal_id'].'"';
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); }
					$j++;
}
...
while ($data2 = mysqli_fetch_assoc($req2)){
					...
					$req = mysqli_query($db,$sql); 
					$mysqlierr=mysqli_error($req);if($mysqlierr!="")echo $mysqlierr."<br>";if($mysqlierr==""){$sql = 'UPDATE `admin_paypal` SET to_table="admin_ebay_taxes_tmp",type_transaction_ok=22,sales_taxes_ok=22 WHERE admin_paypal_id="'.$data2['admin_paypal_id'].'"';
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); }
					$j++;
}
...
$sql2 = 'SELECT * FROM `admin_paypal` WHERE (name="PhoenixSuppliesUSA" OR name="PhoenixSupplies.ca") AND type_transaction_ok=0 order by date_transaction';
$req2 = mysqli_query($db,$sql2); 
while ($data2 = mysqli_fetch_assoc($req2)){
					...
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); 
					$mysqlierr=mysqli_error($req);if($mysqlierr!="")echo $mysqlierr."<br>";if($mysqlierr==""){$sql = 'UPDATE `admin_paypal` SET to_table="admin_transfers",type_transaction_ok=23 WHERE admin_paypal_id="'.$data2['admin_paypal_id'].'"';
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); }
					$j++;
}
...
//ajout Withdraw
$j=0;
$sql2 = 'SELECT * FROM `admin_paypal` WHERE (type_transaction="General Withdrawal") AND type_transaction_ok=0 order by date_transaction';
$req2 = mysqli_query($db,$sql2); 
while ($data2 = mysqli_fetch_assoc($req2)){
					...
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); 
					$mysqlierr=mysqli_error($req);if($mysqlierr!="")echo $mysqlierr."<br>";if($mysqlierr==""){$sql = 'UPDATE `admin_paypal` SET to_table="admin_withdrawals",type_transaction_ok=24 WHERE admin_paypal_id="'.$data2['admin_paypal_id'].'"';
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); }
					$j++;
}
...
while ($data2 = mysqli_fetch_assoc($req2)){
					...
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); 
					$mysqlierr=mysqli_error($req);if($mysqlierr!="")echo $mysqlierr."<br>";if($mysqlierr==""){$sql = 'UPDATE `admin_paypal` SET to_table="admin_currency_conversion",type_transaction_ok=25 WHERE admin_paypal_id="'.$data2['admin_paypal_id'].'"';
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql);} 
					$j++;
}
...
while ($data2 = mysqli_fetch_assoc($req2)){
					...
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); 
					$mysqlierr=mysqli_error($req);if($mysqlierr!="")echo $mysqlierr."<br>";if($mysqlierr==""){$sql = 'UPDATE `admin_paypal` SET to_table="admin_paypal_fee",type_transaction_ok=26 WHERE admin_paypal_id="'.$data2['admin_paypal_id'].'"';
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); }
					$j++;
}
	...
	if($data2['to_table']=="admin_invoice_sales")$table="invoice";
				...
				if($data2['sales_taxes']>0 || $data2['country']=="CA"){
					...
					if($data['country']=="US"){
									...
									//echo $sql."<br>";
									$req = mysqli_query($db,$sql); 
									$mysqlierr=mysqli_error($req);if($mysqlierr!="")echo $mysqlierr."<br>";if($mysqlierr==""){$sql = 'UPDATE `admin_paypal` SET sales_taxes_ok=4 WHERE admin_paypal_id="'.$data2['admin_paypal_id'].'"';
									//echo $sql."<br>";
									$req = mysqli_query($db,$sql);} 
									$data2['sales_taxes']=0;
					...
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); 
					$mysqlierr=mysqli_error($req);if($mysqlierr!="")echo $mysqlierr."<br>";if($mysqlierr==""){$sql = 'UPDATE `admin_paypal` SET to_table="admin_'.$table.'_refunds",type_transaction_ok=27,fee_ok=27  WHERE admin_paypal_id="'.$data2['admin_paypal_id'].'"';
					//echo $sql."<br>";
					$req = mysqli_query($db,$sql); }
					$j++;
	}
...
<body bgcolor="ffffff">
<form id="form_67341" class="appnitro" action="importation_paypal.php" method="post" enctype="multipart/form-data">
