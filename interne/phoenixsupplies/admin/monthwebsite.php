...
if(date('Y-m-d', strtotime($date_select))>date('Y-m-d', strtotime($data2['date_transaction']))){// ||($_POST['year']<=$verfi_date_tmp[0] && $_POST['month']>$verfi_date_tmp[1])){
	...
	$erreur="Derniere mise a jour (".$data2['date_transaction'].")";
}
...
<body bgcolor="ffffff">
<form id="form_67341" class="appnitro" action="monthwebsite.php?month=<?echo $_POST['month'];?>&year=<?echo $_POST['year']?>&tout=<?echo $_GET['tout']?>" method="post" enctype="multipart/form-data">
...
<?
$datas=get_transaction($_POST['year'],$_POST['year'],$_POST['month'],$_POST['month'],"website_sales","currency='USD' AND ",$db);
...
<?
$datas=get_transaction($_POST['year'],$_POST['year'],$_POST['month'],$_POST['month'],"website_sales","currency='CAD' AND ",$db);
//print("<pre>".print_r ($datas,true )."</pre>");
$sales=0;
$fee=0;
$taxes=0;
...
?>
<br><br>
Ventes SITEWEB avec Paypal en CAD
<div class="divTable blueTable">
<div class="divTableHeading">
<div class="divTableRow">
<div class="divTableHead">Date</div>
