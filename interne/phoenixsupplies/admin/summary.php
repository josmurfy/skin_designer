				...
				$yearnow=date("Y");
				  ...
				  for ($i=2018;$i<$yearnow+1;$i++){
					  ...
					  if($init==0){?>
							...
							<div class="divTableCell"><?echo "$ ".number_format(get_sum($i-1,$i-1,11,11,"magasin","",$db),2);?></a></div>
							</div>
							...
							<div class="divTableCell"><?echo "$ ".number_format(get_sum($i-1,$i-1,12,12,"magasin","",$db),2);?></div>
...
<?}
					...
					while ($data2 = mysqli_fetch_assoc($req2)){
						...
						if($i.$data2['id']!=$yearnow.$monthnow){?>
								...
								<div class="divTableCell"><?echo "$ ".number_format(get_sum($i,$i,$data2['id'],$data2['id'],"magasin","",$db),2);?></div>
				...
				$yearnow=date("Y");
				  ...
				  for ($i=2018;$i<$yearnow+1;$i++){
					  ...
					  if($init==0){?>
							...
							<div class="divTableCell"><?echo "$ ".number_format(get_sum($i-1,$i-1,11,11,"magasin","",$db),2);?></div>
							</div>
