 ...
 <table style="text-align: left; width: 1000px; height: 50%; margin-left: auto; margin-right: auto;" border="1" cellpadding="2" cellspacing="2">
    <tbody>
      <tr align="center">
		...
		<img style="width: 488px; height: 145px;" alt="" src="https://phoenixsupplies.ca/image/catalog/cie/entetelow.jpg"><br>
        </td>
      </tr>
      <tr>
	        <tr>
...
<tr>
		...
		<tr>
	         <td colspan="5" rowspan="1" style="vertical-align:  middle; text-align:center;height: 0px; ">
				...
				<img src="https://phoenixsupplies.ca/image/<? echo $_POST['image'];?>" width="200" >
...
<?			$i=0;
			...
			while($data2 = mysqli_fetch_assoc($req2))
			{
				...
				<td style="text-align: center;" align="center" valign="middle"><img src="https://phoenixsupplies.ca/image/
				<?
				echo $data2['image'];
				?>
				" width="200"><br>
