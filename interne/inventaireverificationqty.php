...
if(isset($_POST['verif_fait'])){
		foreach($_POST['verif_fait'] as $verif_fait)  
			{	
				$sql2 = 'UPDATE `oc_product` SET unallocated_quantity="0" where product_id="'.$verif_fait.'"'; 
				//echo $sql2.'<br><br>';
...
<body bgcolor="ffffff">
<form id="form_67341" class="appnitro" action="<?echo $GLOBALS['WEBSITE'];?>/interne/inventaireverificationqty.php" method="post" enctype="multipart/form-data">
...
<table border="1" width="100%">
	...
	<th bgcolor="ff6251">
	<a href="inventairesyncebay.php?order2=<?echo $_GET['order2'];?>&order=P.location" >Titre FR</a>
	
	</th>
	<th bgcolor="ff6251">
	<a href="inventairesyncebay.php?order2=<?echo $_GET['order2'];?>&order=P.quantity" >STOCK</a>
	...
	<th bgcolor="ff6251">
	<a href="inventairesyncebay.php?order2=<?echo $_GET['order2'];?>&order=P.location" >NON PLACé</a>
	 
	</th>
	<th bgcolor="ff6251">
	<a href="inventairesyncebay.php?order2=<?echo $_GET['order2'];?>&order=P.unallocated_quantity" >STOCK</a>
...
<?
		$sql = 'SELECT *,PD.name as nameen,PD1.name as namefr,P.quantity_anc,p.unallocated_quantity,P.location AS location_anc,P.quantity,P.location AS location_entrepot 
				...
				where  PD.language_id=1 and P.unallocated_quantity>0 Order by P.quantity '; //and P.ebay_id=292612778604';  $sql.'<br><br>';/*P.username = "marissa" and P.price_with_shipping>499 verif_fait is null and*/
...
$itemcount=0;
	...
	?>
		...
		<?if ($data['remarque_interne']!=""){?>
								...
								<a href="inventairemagasin.php?sku=<?echo $data['sku'];?>" >A vérifier</a>
		<?}?>
						</td>
...
JsBarcode(".barcode").init();
						...
						<td bgcolor="<?echo $bgcolor;?>">
						<a href="https://bulksell.ebay.com/ws/eBayISAPI.dll?SingleList&sellingMode=ReviseItem&lineID=<?echo $data['marketplace_item_id'];?> " target='ebay' ><?echo $data['marketplace_item_id'];?></a>
						
						</td>

						<td>
						<a href="https://www.ebay.com/sch/i.html?_nkw=<?echo $data['upc']?>&LH_PrefLoc=1&LH_ItemCondition=3&LH_BIN=1&rt=nc" target='ebay1' ><?echo number_format($data['price_with_shipping'],2);?>	</a>	
						</td>
						<td <?if($data['price']>$data['price_with_shipping']){?>style="background-color: red; color: white;"<?}?>>
						<a href="https://www.ebay.com/sch/i.html?_nkw=<?echo $data['nameen']?>&LH_PrefLoc=1&LH_ItemCondition=3&LH_BIN=1&rt=nc" target='ebay2' ><?echo number_format($data['price'],2);?>	</a>	
						</td>
						</tr>
