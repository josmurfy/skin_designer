...
if ($_POST['name_product']!="" && (string)$_POST['sku'] !="" 
	...
	//echo $sql;
		...
		$sql2 .='" WHERE `oc_product`.`usa`=1 and`oc_product`.`upc` ='.substr((string)$_POST['sku'] ,0,12);
...
<h3>SKU <?if($new==1){?><a href="modificationitemusa.php" >Changer d'item</a><?}?> <a href="interneusa.php" >Retour au MENU</a> <a href="multiuploadusa.php" >Retour Photo</a></h3>
