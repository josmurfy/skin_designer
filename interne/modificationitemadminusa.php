...
if($_POST['etat']=="8")$differentiel=.6;
	  		...
	  		$sql9 = 'SELECT * FROM `oc_product_index` where upc="'.substr ((string)$_POST['upc'],0,12).'" group by upc';
			//echo $sql9;
...
<h3><label class="description" for="categorie">Categorie : <b><span style="color: #ff0000;"><?echo $name;?></span></b></label></h3>
