...
class eBaySession
{
    ...
    public function __construct($dev, $app, $cert)
    {
        ...
        $test = @get_headers('http://developer.ebay.com/webservices/1009/eBaySvc.wsdl');

        if (isset($test[0]) && strpos($test[0], 'Not Found') !== false) {
          $this->wsdl = 'http://developer.ebay.com/webservices/1039/eBaySvc.wsdl';
        } else {
          $this->wsdl = 'http://developer.ebay.com/webservices/1009/eBaySvc.wsdl';
        }
