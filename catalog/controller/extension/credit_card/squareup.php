...
class ControllerExtensionCreditCardSquareup extends Controller {
    public function index() {
        ...
        foreach ($this->model_extension_credit_card_squareup->getCards($this->customer->getId()) as $card) {
            $data['cards'][] = array(
    ...
    public function forget() {
        ...
        if ($this->model_extension_credit_card_squareup->verifyCardCustomer($squareup_token_id, $this->customer->getId())) {
            ...
            $customer_info = $this->model_extension_credit_card_squareup->getCustomer($this->customer->getId());
            ...
            try {
                ...
                $first_squareup_token_id = $this->model_extension_credit_card_squareup->getFirstTokenId($this->customer->getId());
                $this->model_extension_credit_card_squareup->updateDefaultCustomerToken($this->customer->getId(), $first_squareup_token_id);
