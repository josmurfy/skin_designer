...
class ControllerExtensionModuleAwesomeSocialLoginOzxmod extends Controller {
	...
	public function template() {
		...
		$this->language->load('extension/module/awesome_social_login_ozxmod');
		...
		$this->session->data['ajaxfblogin_from'] = $server.$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'];
		//echo $this->session->data['ajaxfblogin_from'];
		...
		$client->setRedirectUri($this->url->link('extension/module/awesome_social_login_ozxmod/glogin', '', 'SSL'));
		...
		$data['fb_login'] = $helper->getLoginUrl($this->url->link('extension/module/awesome_social_login_ozxmod/fblogin'), $permissions);
		...
		// Linkedin Login
		$data['linkedin_login'] = $this->url->link('extension/module/awesome_social_login_ozxmod/linkedinlogin', '', 'SSL');
		// End Linkedin Login
		...
		return $this->load->view($default_theme.'extension/module/ozxmod/template_'.$template_id.$tpl, $data);
	}
	...
	public function button_template() {
		...
		return $this->load->view($default_theme.'extension/module/ozxmod/button_template_1'.$tpl, $data);
	}
	...
	public function fblogin() {
		...
		try {
		  $accessToken = $helper->getAccessToken('https://phoenixliquidation.ca/extension/module/awesome_social_login_ozxmod/fblogin');
	...
	public function login_twit(){
		...
		if(!preg_match('/^[^\@]+@.*\.[a-z]{2,6}$/i', $this->request->post['ajax_twit_email'])){
			...
			$json['redirect']= $this->url->link('extension/module/awesome_social_login_ozxmod/twit', '', 'SSL');
	...
	public function twit() {
		...
		//die("0");
		$request_token = $twitteroauth->getRequestToken($this->url->link('extension/module/awesome_social_login_ozxmod/twitter', '', 'SSL'));
	...
	public function linkedinlogin() {
		...
		$client->redirect_uri = $this->url->link('extension/module/awesome_social_login_ozxmod/linkedinlogin', '', 'SSL');
