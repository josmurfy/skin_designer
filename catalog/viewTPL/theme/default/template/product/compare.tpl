    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <table class="table table-bordered">
        ...
        <tr>
          <td></td>
          <?php foreach ($products as $product) { ?>
          <td><?php if ($product['quantity'] <= 0) { ?> <input type="button" value="<?php echo $product['stock_status']; ?>" class="btn btn-primary btn-block" style="cursor: default !important; background: gray !important; color: lightgray !important;" /> <?php } else { ?> <input type="button" value="<?php echo $button_cart; ?>" class="btn btn-primary btn-block" onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');" /> <?php } ?>
