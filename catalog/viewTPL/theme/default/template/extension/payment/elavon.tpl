<form id="payment" class="form-horizontal">
  <fieldset>
    ...
    <div class="form-group required">
      ...
      <div class="col-sm-10">
        <input type="text" disabled="disabled" name="cc_owner" value="<?php echo $cc_owner;?>" placeholder="<?php echo $entry_cc_owner; ?>" id="input-cc-owner" class="form-control" />
      </div>
    </div>
    <div class="form-group required">
...
$('#button-confirm').on('click', function() {
	$.ajax({
		url: 'index.php?route=extension/payment/elavon/send',
		type: 'post',
		data: $('#payment :input'),
		dataType: 'json',
		cache: false,		
