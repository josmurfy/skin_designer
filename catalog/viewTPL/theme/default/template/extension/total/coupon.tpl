<div class="panel panel-default">
  <div class="panel-heading">
    <h4 class="panel-title"><a href="#collapse-coupon" class="accordion-toggle" data-bs-toggle="collapse" data-parent="#accordion"><?php echo $heading_title; ?> <i class="fa fa-caret-down"></i></a></h4>
  </div>
...
$('.cart-heading:eq(1)').addClass('active');
$('.cart-content:eq(1)').slideToggle('slow').effect( "shake", {times:4}, 200 );
});
//--></script>
      <script type="text/javascript"><!--
