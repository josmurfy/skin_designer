<div id="ocmp_spin_wheel">
	<div class="ocmp-<?php echo $spin_wheel['display']; ?>-container" style="<?php if( $spin_wheel['display'] == 'full') { ?> height: 100%; position: fixed; left: 0px; bottom: 0px; top: 0px; z-index: 100000; <?php } ?> display: none;">
		<div class="<?php echo $spin_wheel['display']; ?>-background"></div>
		<div class="ocmp_spin_content">
			<div class="ocmp_form_info">
				<div class="ocmp_offer_description" style="color:<?php echo $spin_wheel['text_color'] ? $spin_wheel['text_color'] : '#ffffff'; ?>">
					<div class="spin-description">
						<div class="ocmp-title"><?php echo isset($spin_wheel[$language_id]) ? $spin_wheel[$language_id]['title'] : ''; ?></div>
						<div class="ocmp-sub-title">
							<span><?php echo isset($spin_wheel[$language_id]) ? $spin_wheel[$language_id]['sub_title'] : ''; ?></span>
						</div>
						<?php if($notes){ ?>
							<ul class="ocmp-note">	
					...
					<div class="spin-form">
						...
						<div class="ocmp-button">	
							<button class="btn btn-block btn-lg" id="btn-spin-wheel"><?php echo $spin_wheel[$language_id]['btn_label']; ?></button>
						</div>
						<div class="ocmp-text-noluck text-right">	
							<span class="close_popup"><?php echo $spin_wheel[$language_id]['text_no_luck']; ?></span>
						</div>	
					</div>
				...
				<div class="ocmp_spinners">
					<div class="ocmp_spinner">
						...
						<?php foreach($wheel_offers as $wheel_offer){    ?>
							<span class="wheel-offers offer-<?php echo $q; ?>" style="transform: rotate(-<?php echo $rotate; ?>deg) translate(10px, -50%);"><?php echo $wheel_offer['label']; ?></span>
							<?php $rotate = $q * 30; ?>
						<?php $q++; } ?>	
					</div>
