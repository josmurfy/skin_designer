<?php
//==============================================================================
// Stripe Payment Gateway v303.12  (also set below)
// 
...
class ModelExtensionPaymentStripe extends Model {		
	...
	private $name = 'stripe';
	private $extension_version = 'v303.12';
	...
	public function curlRequest($request, $api, $data = array()) {
		...
		/* if($data['currency']=="cad"){
			curl_setopt($curl, CURLOPT_USERPWD, $settings[$settings['transaction_mode'] . '_access_token_cad'] . ':');
		}else{ */
