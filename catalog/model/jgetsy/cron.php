...
class ModelJgetsyCron extends Model {
    ...
    public function getShippingTemplatesToAdd() {
        $query = $this->db->query("SELECT * FROM " . DB_PREFIX . "etsy_shipping_profiles WHERE shipping_profile_id IS NULL");
        if ($query->num_rows) {
            return $query->rows;
        } else {
            return 0;
    ...
    public function getShippingTemplatesToRenew() {
        $query = $this->db->query("SELECT * FROM " . DB_PREFIX . "etsy_shipping_profiles WHERE shipping_profile_id IS NOT NULL AND shipping_profile_id != '' AND shipping_profile_id != 0 AND renew_flag = '1' AND delete_flag = '0'");
        if ($query->num_rows) {
            return $query->rows;
        } else {
            return 0;
    ...
    public function getShippingTemplatesToDelete() {
        $query = $this->db->query("SELECT * FROM " . DB_PREFIX . "etsy_shipping_profiles WHERE shipping_profile_id IS NOT NULL AND shipping_profile_id != '' AND shipping_profile_id != 0 AND delete_flag = '1'");
        if ($query->num_rows) {
            return $query->rows;
        } else {
            return 0;
    ...
    public function updateShippingTemplates($id, $data) {
        $this->db->query("UPDATE " . DB_PREFIX . "etsy_shipping_profiles SET renew_flag = '0', shipping_profile_id = '" . $data[0]['shipping_profile_id'] . "' WHERE id_etsy_shipping_profiles = '" . (int) $id . "'");
        $this->db->query("DELETE FROM " . DB_PREFIX . "etsy_shipping_profiles_entries WHERE id_etsy_shipping_profiles = '" . $id . "'");
        ...
        if (!empty($data[0]['Entries'])) {
            foreach ($data[0]['Entries'] as $entry) {
                ...
                if ($destination_region_id != "") {
                    $template_entry_region_exist = $this->db->query("SELECT * FROM " . DB_PREFIX . "etsy_shipping_profiles_entries WHERE shipping_entry_destination_region_id = " . $destination_region_id);
                    if ($template_entry_region_exist->num_rows > 0) {
                        $insert_entry = false;
                    }
                }
                if ($insert_entry == true) {
                    $this->db->query("INSERT INTO " . DB_PREFIX . "etsy_shipping_profiles_entries("
                            ...
                            . ") VALUES("
                            . "'" . $id . "',"
                            . "'" . $entry['shipping_profile_entry_id'] . "',"
    ...
    public function deleteShippingTemplate($id, $shipping_profile_id) {
        $this->db->query("DELETE FROM " . DB_PREFIX . "etsy_shipping_profiles WHERE shipping_profile_id = '" . $shipping_profile_id . "' AND id_etsy_shipping_profiles = '" . (int) $id . "'");
        $this->db->query("DELETE FROM " . DB_PREFIX . "etsy_shipping_profiles_entries WHERE id_etsy_shipping_profiles = '" . $id . "'");
    }

    public function getAllShippingTemplates() {
        $query = $this->db->query("SELECT * FROM " . DB_PREFIX . "etsy_shipping_profiles WHERE shipping_profile_id IS NOT NULL AND shipping_profile_id != '' AND shipping_profile_id != 0");
        if ($query->num_rows) {
            return $query->rows;
        } else {
            return 0;
    ...
    public function getShippingTemplateEntriesToAdd($id) {
        $query = $this->db->query("SELECT * FROM " . DB_PREFIX . "etsy_shipping_profiles_entries WHERE id_etsy_shipping_profiles = '" . (int) $id . "' AND shipping_profile_entry_id IS NULL");
        if ($query->num_rows) {
            return $query->rows;
        } else {
            return 0;
    ...
    public function getShippingTemplateEntriesToUpdate() {
        $query = $this->db->query("SELECT * FROM " . DB_PREFIX . "etsy_shipping_profiles_entries WHERE shipping_profile_entry_id IS NOT NULL AND shipping_profile_entry_id != '' AND shipping_profile_entry_id != 0 AND renew_flag = '1' AND delete_flag = '0'");
        if ($query->num_rows) {
            return $query->rows;
        } else {
            return 0;
    ...
    public function getShippingTemplateEntriesToDelete() {
        $query = $this->db->query("SELECT * FROM " . DB_PREFIX . "etsy_shipping_profiles_entries WHERE shipping_profile_entry_id IS NOT NULL AND shipping_profile_entry_id != '' AND shipping_profile_entry_id != 0 AND delete_flag = '1'");
    ...
    public function updateShippingTemplateEntryStatus($shippingTemplateEntryID, $local_entry_id) {
        $this->db->query("UPDATE " . DB_PREFIX . "etsy_shipping_profiles_entries SET renew_flag = '0', shipping_profile_entry_id = '" . $shippingTemplateEntryID . "' WHERE id_etsy_shipping_profiles_entries = '" . (int) $local_entry_id . "'");
    }

    public function deleteShippingTemplateEntry($id) {
        $this->db->query("DELETE FROM " . DB_PREFIX . "etsy_shipping_profiles_entries WHERE id_etsy_shipping_profiles_entries = '" . (int) $id . "'");
    }
