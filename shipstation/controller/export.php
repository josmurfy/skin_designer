...
class ControllerExport extends Controller {
    ...
    public function index() {
        ...
        if (isset($this->request->get['start_date']) && $this->request->get['start_date']) {
            $start_date_time = explode(' ', urldecode($this->request->get['start_date']));
            $startdate = explode('/', $start_date_time[0]);
            $start_date_time_s = isset($start_date_time[1]) ? $start_date_time[1] : '00:00';
            $starttime = explode(':', $start_date_time_s);
        ...
        if (isset($this->request->get['end_date']) && $this->request->get['end_date']) {
            $end_date_time = explode(' ', urldecode($this->request->get['end_date']));
            $enddate = explode('/', $end_date_time[0]);
            $end_date_time_s = isset($end_date_time[1]) ? $end_date_time[1] : '00:00';
            $endtime = explode(':', $end_date_time_s);
