    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <a href="<?php echo $keygen; ?>" class="btn btn-primary" id="keygen"><?php echo $button_keygen; ?></a>
                <button type="submit" form="form-canuship" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-canuship" class="form-horizontal">
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="input-status"><?php echo $entry_status; ?></label>
                        <div class="col-sm-9">
                            <select name="canuship_status" id="input-status" class="form-control">
                                <?php if ($canuship_status) { ?>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="canuship_config_key" value="<?php echo $canuship_config_key; ?>" placeholder="<?php echo $entry_config_key; ?>" id="entry-config_key" class="form-control"/>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="canuship_verify_key" value="<?php echo $canuship_verify_key; ?>" placeholder="<?php echo $entry_config_ver_key; ?>" id="entry-config_ver_key" class="form-control"/>
