                ...
                <div class="panel-body">
                    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-google-captcha" class="form-horizontal">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="active">
                                <a href="#tab-general" data-toggle="tab"><?php echo $tab_general; ?>
                                </a>
                            </li>
                            <li>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab-general">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-key"><?php echo $entry_register_site; ?></label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="google_captcha_v3_key" value="<?php echo $google_captcha_v3_key; ?>" placeholder="<?php echo $entry_key; ?>" id="input-key" class="form-control" />
                                        <?php if ($error_key) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="google_captcha_v3_secret" value="<?php echo $google_captcha_v3_secret; ?>" placeholder="<?php echo $entry_secret; ?>" id="input-secret" class="form-control" />
                                        <?php if ($error_secret) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="google_captcha_v3_status" id="input-status" class="form-control">
                                            <?php if ($google_captcha_v3_status) { ?>
