...
<div id="content">
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="form-group">
              ...
              <select id="filter-marketplace" name="filter_marketplace_account_id" class="form-control">
                <?php foreach ($marketplaces as $marketplace) { ?>
                <?php if ($filter_marketplace_account_id == $marketplace['code']) { ?>
  ...
  $('#button-filter').bind('click', function() {
    ...
    url += '&filter_marketplace_account_id=' + $("select[name='filter_marketplace_account_id']").val();
    location = url;
  });
  ...
  $('#button-list').bind('click', function(e) {
    ...
    if (request_data) {
      request_data += '&marketplace=<?php echo $filter_marketplace_account_id ?>';
    }
