      ...
      <div class="panel-body">
        <div class="well">
          <div class="row">
            ...
            <div class="col-sm-4">
              <div class="form-group">
                <label class="control-label" for="filter_marketplace_account_id"><?php echo $entry_status_marketplace; ?></label>
                <select name="filter_marketplace_account_id" id="filter_marketplace_account_id" class="form-control">
                  <option value="all" <?php echo (!isset($filter_marketplace_account_id) || $filter_marketplace_account_id == 'all' ? ' selected' : ''); ?>><?php echo $text_status_all; ?></option>
                  <?php if ($marketplace_statuses['ebay']) { ?>
                  <option value="ebay_active" <?php echo ($filter_marketplace_account_id == 'ebay_active' ? ' selected' : ''); ?>><?php echo $text_status_ebay_active; ?></option>
                  <option value="ebay_inactive" <?php echo ($filter_marketplace_account_id == 'ebay_inactive' ? ' selected' : ''); ?>><?php echo $text_status_ebay_inactive; ?></option>
                  <?php } ?>
                  <?php if ($marketplace_statuses['amazon']) { ?>
                  <option value="amazon_saved" <?php echo ($filter_marketplace_account_id == 'amazon_saved' ? ' selected' : ''); ?>><?php echo $text_status_amazoneu_saved; ?></option>
                  <option value="amazon_uploaded" <?php echo ($filter_marketplace_account_id == 'amazon_uploaded' ? ' selected' : ''); ?>><?php echo $text_status_amazoneu_processing; ?></option>
                  <option value="amazon_ok" <?php echo ($filter_marketplace_account_id == 'amazon_ok' ? ' selected' : ''); ?>><?php echo $text_status_amazoneu_active; ?></option>
                  <option value="amazon_unlisted" <?php echo ($filter_marketplace_account_id == 'amazon_unlisted' ? ' selected' : ''); ?>><?php echo $text_status_amazoneu_notlisted; ?></option>
                  <option value="amazon_error" <?php echo ($filter_marketplace_account_id == 'amazon_error' ? ' selected' : ''); ?>><?php echo $text_status_amazoneu_failed; ?></option>
                  <option value="amazon_linked" <?php echo ($filter_marketplace_account_id == 'amazon_linked' ? ' selected' : ''); ?>><?php echo $text_status_amazoneu_linked; ?></option>
                  <option value="amazon_not_linked" <?php echo ($filter_marketplace_account_id == 'amazon_not_linked' ? ' selected' : ''); ?>><?php echo $text_status_amazoneu_notlinked; ?></option>
                  <?php } ?>
                  <?php if ($marketplace_statuses['amazonus']) { ?>
                  <option value="amazonus_saved" <?php echo ($filter_marketplace_account_id == 'amazonus_saved' ? ' selected' : ''); ?>><?php echo $text_status_amazonus_saved; ?></option>
                  <option value="amazonus_uploaded" <?php echo ($filter_marketplace_account_id == 'amazonus_uploaded' ? ' selected' : ''); ?>><?php echo $text_status_amazonus_processing; ?></option>
                  <option value="amazonus_ok" <?php echo ($filter_marketplace_account_id == 'amazonus_ok' ? ' selected' : ''); ?>><?php echo $text_status_amazonus_active; ?></option>
                  <option value="amazonus_unlisted" <?php echo ($filter_marketplace_account_id == 'amazonus_unlisted' ? ' selected' : ''); ?>><?php echo $text_status_amazonus_notlisted; ?></option>
                  <option value="amazonus_error" <?php echo ($filter_marketplace_account_id == 'amazonus_error' ? ' selected' : ''); ?>><?php echo $text_status_amazonus_failed; ?></option>
                  <option value="amazonus_linked" <?php echo ($filter_marketplace_account_id == 'amazonus_linked' ? ' selected' : ''); ?>><?php echo $text_status_amazonus_linked; ?></option>
                  <option value="amazonus_not_linked" <?php echo ($filter_marketplace_account_id == 'amazonus_not_linked' ? ' selected' : ''); ?>><?php echo $text_status_amazonus_notlinked; ?></option>
                  <?php } ?>
                </select>
              </div>
              <div class="form-group">
...
<script type="text/javascript"><!--
  function filter() {
      ...
      var filter_marketplace_account_id = $('select[name=\'filter_marketplace_account_id\']').find(":selected").val();

      if (filter_marketplace_account_id) {
          url += '&filter_marketplace_account_id=' + encodeURIComponent(filter_marketplace_account_id);
      }
