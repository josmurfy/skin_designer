                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <?php if($product['listing_status'] == 'Pending' && $product['is_disabled'] == 0) { ?>
                                                        <a target="_blank" href="<?php echo HTTPS_CATALOG . 'index.php?route=jgetsy/product&secure_key='.$secure_key; ?>&etsy_product_id=<?php echo $product['product_id']; ?>" data-toggle="tooltip" title="<?php echo $sync_product_to_etsy; ?>" class="btn btn-success"><i class="fa fa-refresh"></i></a>
                                                <?php } ?>
                                                ...
                                                <?php if(($product['listing_status'] == 'Listed' || $product['listing_status'] == 'Inactive'  || $product['listing_status'] == 'Expired') && $product['is_disabled'] == 0 && ($product['update_flag'] == '1' || $product['renew_flag'] == '1')) { ?>
                                                        <a target="_blank" href="<?php echo HTTPS_CATALOG . 'index.php?route=jgetsy/product&secure_key='.$secure_key; ?>&update=1&etsy_product_id=<?php echo $product['product_id']; ?>" data-toggle="tooltip" title="<?php echo $sync_product_to_etsy; ?>" class="btn btn-success"><i class="fa fa-refresh"></i></a>
                                                <?php } ?>
