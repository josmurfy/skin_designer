        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="etsy-shipping-temp-add" class="form-horizontal">
                    <input type="hidden" name="shipping_profiles_entries" value="shipping_profiles_entries"/>
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            ...
                            <?php if (isset($id_etsy_shipping_profiles_entries)) { ?>
                                <input type="hidden" name="id_etsy_shipping_profiles_entries" value="<?php echo $id_etsy_shipping_profiles_entries; ?>" placeholder="" id="id_etsy_shipping_profiles_entries" class="form-control"/>
                            <?php } ?>
                            <?php if (isset($id_etsy_shipping_profiles)) { ?>
                                <input type="hidden" name="id_etsy_shipping_profiles" value="<?php echo $id_etsy_shipping_profiles; ?>" placeholder="" id="id_etsy_shipping_profiles" class="form-control"/>
                            <?php } ?>
                        </div>
                    </div>
