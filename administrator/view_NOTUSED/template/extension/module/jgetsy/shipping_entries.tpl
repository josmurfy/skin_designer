                ...
                <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-product">
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <?php if ($shipping_profile_entries) { ?>
                                    <?php foreach ($shipping_profile_entries as $templates) { ?>
                                        <tr>
...
$('#button-filter').on('click', function () {
        var url = 'index.php?route=<?php echo $module_path; ?>/shippingProfileEntries&<?php echo $session_token_key; ?>=<?php echo $token; ?>';
