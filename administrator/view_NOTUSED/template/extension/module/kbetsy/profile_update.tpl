        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="etsy-profile-add" class="form-horizontal">
                    ...
                    <div class="form-group required">
                        <label class="col-sm-2 control-label" for="etsy_templates"><?php echo $text_shipping_template; ?></label>
                        <div class="col-sm-10">
                            <select name="etsy[profile][etsy_templates]" id="etsy-category" class="form-control">
                                ...
                                <?php foreach ($etsy_ship_templates as $templates) { ?>
                                    <?php if ($templates['id_etsy_shipping_templates'] == $etsy_templates) { ?>
                                        <option value="<?php echo $templates['id_etsy_shipping_templates']; ?>" selected="selected"><?php echo $templates['shipping_template_title']; ?></option>
                                    <?php } else { ?>
                                        <option value="<?php echo $templates['id_etsy_shipping_templates']; ?>"><?php echo $templates['shipping_template_title']; ?></option>
                                    <?php } ?>
                                <?php } ?>
                            </select>
                ...
                <?php } else { ?>
                <div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i>
                    <?php echo $shipping_template_not_avaliable_error; ?>
                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                </div>
                <?php } ?>
            </div>
