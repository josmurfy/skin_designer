                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-6 customHeight">
                                    <div class="productOCList" style="height: 374px;">
                                        <div class="productImage">
                                            <img src="view/image/kbetsy/multi-vendor-marketplace.jpg">
                                        </div>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6 customHeight">
                                    <div class="productOCList" style="height: 374px;">
                                        <div class="productImage">
                                            <img src="view/image/kbetsy/Opencart--ebay.jpg">
                                        </div>
                                        <div class="productContent">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6 customHeight">
                                    <div class="productOCList" style="height: 374px;">
                                        <div class="productImage">
                                            <img src="view/image/kbetsy/google-shopping.jpg">
                                        </div>
                                        <div class="productContent">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6 customHeight">
                                    <div class="productOCList" style="height: 374px;">
                                        <div class="productImage">
                                            <img src="view/image/kbetsy/Mobile-app-opencart-plugin.jpg">
                                        </div>
                                        <div class="productContent">
