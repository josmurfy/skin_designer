    ...
    <div class="page-header">
        <div class="container-fluid">
            ...
            <div class="pull-right">
                <a target="_blank" href="<?php echo $sync_template_url; ?>" data-toggle="tooltip" title="<?php echo $text_sync_shipping_template; ?>" class="btn btn-primary"><i class="fa fa-refresh"></i></a>
                            ...
                            <table class="table table-bordered table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <td class="text-left">
                                            <?php if ($sort == 'id_etsy_shipping_templates') { ?>
                                                <a href="<?php echo $sort_id_etsy_shipping_templates; ?>" class="<?php echo $order; ?>"><?php echo $column_template_id; ?></a>
                                            <?php } else { ?>
                                                <a href="<?php echo $sort_id_etsy_shipping_templates; ?>"><?php echo $column_template_id; ?></a>
                                            <?php } ?>
                                        </td>
                                        <td class="text-left">
                                            <?php if ($sort == 'shipping_template_title') { ?>
                                                <a href="<?php echo $sort_shipping_template_title; ?>" class="<?php echo $order; ?>"><?php echo $column_shipping_title; ?></a>
                                            <?php } else { ?>
                                                <a href="<?php echo $sort_shipping_template_title; ?>"><?php echo $column_shipping_title; ?></a>
                                            <?php } ?>
                                        </td>
                                        <td class="text-left">
                                ...
                                <tbody>
                                    <?php if ($shipping_templates) { ?>
                                        <?php foreach ($shipping_templates as $templates) { ?>
                                            <tr>
                                                <td class="text-center">
                                                    <?php if (in_array($templates['id_etsy_shipping_templates'], $selected)) { ?>
                                                        <input type="checkbox" name="selected[]" value="<?php echo $templates['id_etsy_shipping_templates']; ?>" checked="checked" />
                                                    <?php } else { ?>
                                                        <input type="checkbox" name="selected[]" value="<?php echo $templates['id_etsy_shipping_templates']; ?>" />
                                                    <?php } ?>
                                                </td>
                                                <td class="text-left"><?php echo $templates['id_etsy_shipping_templates']; ?></td>
                                                <td class="text-left"><?php echo $templates['shipping_template_title']; ?></td>
                                        ...
                                        <tr>
                                            <td class="text-left" colspan="9">
                                                <div class="alert alert-warning">
                                                    <i class="fa fa-check-circle"></i> <?php echo $text_no_shipping_template_error; ?>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php } ?>
...
$('#button-filter').on('click', function () {
        var url = 'index.php?route=<?php echo $module_path; ?>/shippingTemplates&<?php echo $session_token_key; ?>=<?php echo $token; ?>';
