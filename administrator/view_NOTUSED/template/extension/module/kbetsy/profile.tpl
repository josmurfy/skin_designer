                                ...
                                <table class="table table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <td class="text-left"><?php if ($sort == 'p.etsy_category_code') { ?>
                                                ...
                                                <?php } ?></td>
                                            <td class="text-left"><?php if ($sort == 'st.shipping_template_title') { ?>
                                                <a href="<?php echo $sort_shipping_template_title; ?>" class="<?php echo $order; ?>"><?php echo $column_profile_shipping; ?></a>
                                                <?php } else { ?>
                                                <a href="<?php echo $sort_shipping_template_title; ?>"><?php echo $column_profile_shipping; ?></a>
                                                <?php } ?></td>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-left"><?php echo $profile['shipping_template_title']; ?></td>
