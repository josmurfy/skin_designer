...
<div class="form-horizontal">
  <div class="form-group">
    ...
    <div class="col-sm-10">
		<div class="well well-sm" style="max-height: 200px; overflow: auto;">
			...
			<?php foreach ($order_products as $product) { ?>
				...
				<select name="qty[<?php echo $product['order_product_id']; ?>]" onChange="auto_select_checkbox(<?php echo $product['order_product_id']; ?>, this.value);" class="form-control">
					<?php for ($i = $product['remaining_qty']; $i >= 0; $i--) { ?>
  ...
  <div class="form-group">
    <div class="col-sm-2">
		<div style="margin-top:10px;margin-bottom:10px;font-size:12px; font-weight:bold; text-align:center;">TRACKING INFORMATION</div>
	</div>
    <div class="col-sm-10">
		<div class="col-sm-2">
			<div style="margin-top:10px;margin-bottom:10px;font-size:12px; font-weight:bold; text-align:center;"><?php echo $label_courier; ?></div>
			<div id="courier_dd">
		...
		<div class="col-sm-2">
			<div style="margin-top:10px;margin-bottom:10px;font-size:12px; font-weight:bold; text-align:center;"><?php echo $label_courier_track; ?></div>
			<div id="courier_track">
				<input class="form-control" name="courier_tracking_id" id="courier_tracking_id" value="">
			</div>
		</div>
		<div class="col-sm-2">
			<div style="margin-top:10px;margin-bottom:10px;font-size:12px; font-weight:bold; text-align:center;">Shipment Order Status</div>
		...
		<div class="col-sm-2">
			<div style="margin-top:10px;margin-bottom:10px;font-size:12px; font-weight:bold; text-align:center;"><?php echo $label_courier_date; ?></div>
		...
		<div class="col-sm-4">
			<div style="margin-top:10px;margin-bottom:10px;font-size:12px; font-weight:bold;">Action</div>
