              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="abandoned_template_description[<?php echo $language['language_id']; ?>][subject]" value="<?php echo isset($abandoned_template_description[$language['language_id']]) ? $abandoned_template_description[$language['language_id']]['subject'] : ''; ?>" placeholder="<?php echo $entry_subject; ?>" id="input-subject<?php echo $language['language_id']; ?>" class="form-control" />
									...
									<div class="col-sm-10">
										<div class="panel panel-default">
											...
											<div class="panel-body">
												...
												<p><span>{cart_page_link} - Cart Page Link </h4></span></p>
												<p><span>{store} - Store Name</h4></span></p>
												<p><span>{store_url} - Store Url</h4></span></p>
											</div>
										</div>
									</div>
								</div>
