  ...
  <div style="page-break-after: always;">
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        ...
        <tr>
          <td>ENTREPOT: <br><?php echo $product['location_entrepot']; ?>-->(<?php echo $product['quantity']; ?>)<br> -->(<?php echo $product['unallocated_quantity']; ?>)</td>
          <td text-align=center><?php if ($product['sku']) { ?>
            <?php //echo $text_sku; ?> <?php //echo $product['sku']; ?>
            <?php } ?>
			
			<svg class="barcode"
				jsbarcode-value="<?echo (string)$product['sku'];?>"
            ...
            <?php //} ?></td>
          <td><table><tr><td width=110>
		  <img src="https://www.phoenixliquidation.ca/image/<? echo $product['image'];?>" width="100" >
		  </td><td>
