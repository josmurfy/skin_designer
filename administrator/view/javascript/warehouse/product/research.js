...
function ChangeManufacturer(filter_name) {
    ...
    $.ajax({
        url: 'index.php?route=catalog/manufacturer/autocomplete&user_token=' + user_token + '&filter_name=' + encodeURIComponent(filter_name),
        dataType: 'json',
...
function handleManufacturerResponse(manufacturers, filter_name) {
    ...
    if (manufacturers.length > 0) {
        ...
        if (selected.value === 0) {
            if (confirm(TEXT_CONFIRM_MANUFACTURER_NOT_FOUND_ADD)) {
