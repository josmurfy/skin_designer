               ...
               <div class="form-group">
				...
				<select name="filter_store" class="form-control" >
					...
					<?php if(isset($stores))
					{
						...
						?>
							<option <?php echo $sel ?> value="<?php echo $store['store_id']?>"><?php echo $store['name']?></option>
						<?php
						}
              ...
              <div class="form-group">
               ...
               <select name="filter_user" class="form-control" >
					...
					<?php if(isset($users))
					{
						...
						{
							$sel="";
							if($filter_user==$user['user_id'])
							{
							$sel="selected";
							}
						?>
							<option <?php echo $sel ?> value="<?php echo $user['user_id']?>"><?php echo $user['username']?></option>
						<?php
						}
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
				...
				<td  class="text-right"><?php echo $pagetotal ?></td>
				<td colspan="2"></td>
				</tr>
                <?php } else { ?>
                <tr>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=pos/posorder&token=<?php echo $token; ?>';
