		...
		<div class="text-right">
			<button type="button" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary addcustomer"><i class="fa fa-save" style="color:#fff!important;"></i></button>
			
			<a href="<?php echo $cancel; ?>" data-dismiss="modal" title="<?php echo $button_cancel; ?>" class="btn btn-default"><i class="fa fa-reply"></i></a>
		</div>		
		
		<div class="form-horizontal add-customer">
