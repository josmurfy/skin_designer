...
class ModelKbetsyKbetsy extends Model
{
    ...
    public function install()
    {
        ...
        $profileTableSQL = "CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "etsy_profiles` (
                            ...
                            KEY `etsy_category_code` (`etsy_category_code`,`id_etsy_shipping_templates`,`is_customizable`,`who_made`,`when_made`,`is_supply`,`recipient`(1),`occassion`(1))
                          ) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=latin1;";
        ...
        $createTableSQL = "CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "etsy_shipping_templates` (
        ...
        $createTableSQL = "CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "etsy_shipping_templates_entries` (
        ...
        if(empty($this->model_setting_setting->getSetting('kbetsy_secure_key'))) {
            $secure_key['kbetsy_secure_key'] = $this->generateRandomString();
            $this->model_setting_setting->editSetting('kbetsy_secure_key', $secure_key);
        }
    }
    ...
    public function getShippingTemplateById($id_etsy_shipping_templates)
    {
        $query = $this->db->query("SELECT * FROM " . DB_PREFIX . "etsy_shipping_templates WHERE id_etsy_shipping_templates = " . $id_etsy_shipping_templates);
        if ($query->num_rows > 0) {
            return $query->row;
        } else {
            return false;
    ...
    public function shippingTemplateUpdate($data)
    {
        ...
        if (isset($data['id_etsy_shipping_templates']) && $data['id_etsy_shipping_templates'] != "") {
            $this->db->query("UPDATE " . DB_PREFIX . "etsy_shipping_templates SET shipping_template_title = '" . $data['etsy']['template']['template_title'] . "', shipping_origin_country_id = '" . $data['etsy']['template']['origin_country'] . "',shipping_origin_country = '" . $country_name . "', shipping_primary_cost = " . $data['etsy']['template']['primary_cost'] . ", shipping_secondary_cost = " . $data['etsy']['template']['secondary_cost'] . ", shipping_min_process_days = " . $data['etsy']['template']['min_process_days'] . ", shipping_max_process_days = " . $data['etsy']['template']['max_process_days'] . ", renew_flag = '1' WHERE id_etsy_shipping_templates = " . $data['id_etsy_shipping_templates']);
        } else {
            $this->db->query("INSERT INTO " . DB_PREFIX . "etsy_shipping_templates SET shipping_template_title = '" . $data['etsy']['template']['template_title'] . "', shipping_origin_country_id = '" . $data['etsy']['template']['origin_country'] . "',shipping_origin_country = '" . $country_name . "', shipping_primary_cost = " . $data['etsy']['template']['primary_cost'] . ", shipping_secondary_cost = " . $data['etsy']['template']['secondary_cost'] . ", shipping_min_process_days = " . $data['etsy']['template']['min_process_days'] . ", shipping_max_process_days = " . $data['etsy']['template']['max_process_days']);
        }
    }

    public function shippingTemplateEntryUpdate($data)
    {
        ...
        if (isset($data['id_etsy_shipping_templates_entries']) && $data['id_etsy_shipping_templates_entries'] != "" && $data['id_etsy_shipping_templates_entries'] != 0) {
            $this->db->query("UPDATE " . DB_PREFIX . "etsy_shipping_templates_entries SET shipping_entry_destination_region_id = '" . (int) $shipping_entry_destination_region_id . "', shipping_entry_destination_region = '" . $this->db->escape($destination_region_name) . "', shipping_entry_primary_cost = '" . (float) $data['etsy']['template']['primary_cost'] . "', shipping_entry_secondary_cost = '" . (float) $data['etsy']['template']['secondary_cost'] . "', shipping_entry_destination_country_id = '" . $shipping_entry_destination_country_id . "', shipping_entry_destination_country = '" . $this->db->escape($destination_country_name) . "', renew_flag = '1' WHERE id_etsy_shipping_templates_entries = '" . (int) $data['id_etsy_shipping_templates_entries'] . "'");
        } else {
            $this->db->query("INSERT INTO " . DB_PREFIX . "etsy_shipping_templates_entries VALUES (NULL, '" . (int) $data['id_etsy_shipping_templates'] . "', NULL, '" . (int) $shipping_entry_destination_country_id . "', '" . $this->db->escape($destination_country_name) . "', '" . (float) $data['etsy']['template']['primary_cost'] . "', '" . (float) $data['etsy']['template']['secondary_cost'] . "', " . (int) $shipping_entry_destination_region_id . ", '" . $this->db->escape($destination_region_name) . "', '0', '0', NOW(), NOW())");
        }
    }

    public function deleteShippingTemplateEntries($id_etsy_shipping_templates_entries = 0)
    {
        $checkSQL = $this->db->query("SELECT * FROM " . DB_PREFIX . "etsy_shipping_templates_entries WHERE id_etsy_shipping_templates_entries = '" . (int) $id_etsy_shipping_templates_entries . "'");
        if ($checkSQL->num_rows > 0) {
            if ($checkSQL->row['shipping_template_entry_id'] == NULL) {
                $this->db->query("DELETE FROM " . DB_PREFIX . "etsy_shipping_templates_entries WHERE id_etsy_shipping_templates_entries = '" . (int) $id_etsy_shipping_templates_entries . "' LIMIT 1");
            } else {
                $this->db->query("UPDATE " . DB_PREFIX . "etsy_shipping_templates_entries set delete_flag = '1' WHERE id_etsy_shipping_templates_entries = '" . (int) $id_etsy_shipping_templates_entries . "'");
            }
        }
    }

    public function checkProfileMapping($id_etsy_shipping_templates = 0)
    {
        $profileMappingExistence = $this->db->query("SELECT count(*) as count FROM " . DB_PREFIX . "etsy_profiles WHERE id_etsy_shipping_templates = '" . (int) $id_etsy_shipping_templates . "'");
    ...
    public function deleteShippingTemplate($id_etsy_shipping_templates = 0)
    {
        $checkShippingTemplateSQL = $this->db->query("SELECT * FROM " . DB_PREFIX . "etsy_shipping_templates WHERE id_etsy_shipping_templates = '" . (int) $id_etsy_shipping_templates . "'");
        if ($checkShippingTemplateSQL->num_rows > 0) {
            if ($checkShippingTemplateSQL->row['shipping_template_id'] == NULL) {
                $this->db->query("DELETE FROM " . DB_PREFIX . "etsy_shipping_templates WHERE id_etsy_shipping_templates = '" . (int) $id_etsy_shipping_templates . "' LIMIT 1");
                $this->db->query("DELETE FROM " . DB_PREFIX . "etsy_shipping_templates_entries WHERE id_etsy_shipping_templates = '" . (int) $id_etsy_shipping_templates . "'");
            } else {
                $this->db->query("UPDATE " . DB_PREFIX . "etsy_shipping_templates set delete_flag = '1' WHERE id_etsy_shipping_templates = '" . (int) $id_etsy_shipping_templates . "'");
                $this->db->query("UPDATE " . DB_PREFIX . "etsy_shipping_templates_entries set delete_flag = '1' WHERE id_etsy_shipping_templates = '" . (int) $id_etsy_shipping_templates . "'");
            }
        }
        return true;
    }
    ...
    public function getProfileTotal($data = array())
    {
        ...
        if (isset($data['filter_shipping_name']) && !is_null($data['filter_shipping_name'])) {
            $sql .= " AND st.shipping_template_title LIKE '" . $this->db->escape($data['filter_shipping_name']) . "%'";
        }
    ...
    public function getProfileDetails($data, $id_etsy_profiles = '')
    {
        if (!empty($id_etsy_profiles)) {
            $sql = "SELECT p.*,st.shipping_template_title,ec.category_name FROM " . DB_PREFIX . "etsy_profiles p LEFT JOIN " . DB_PREFIX . "etsy_shipping_templates st ON (st.id_etsy_shipping_templates = p.id_etsy_shipping_templates) LEFT JOIN " . DB_PREFIX . "etsy_category_mapping ecm ON (ecm.id_etsy_profiles = p.id_etsy_profiles) LEFT JOIN " . DB_PREFIX . "etsy_categories ec ON (ec.category_code = ecm.etsy_category_code) where p.id_etsy_profiles = " . $id_etsy_profiles;
        } else {
            $sql = "SELECT p.*,st.shipping_template_title,ec.category_name FROM " . DB_PREFIX . "etsy_profiles p LEFT JOIN " . DB_PREFIX . "etsy_shipping_templates st ON (st.id_etsy_shipping_templates = p.id_etsy_shipping_templates) LEFT JOIN " . DB_PREFIX . "etsy_category_mapping ecm ON (ecm.id_etsy_profiles = p.id_etsy_profiles) LEFT JOIN " . DB_PREFIX . "etsy_categories ec ON (ec.category_code = ecm.etsy_category_code) where p.id_etsy_profiles > 0";
        }
    ...
    public function getShippingTemplateTotal($data, $id_etsy_shipping_templates = '')
    {
        if (!empty($id_etsy_shipping_templates)) {
            $sql = "SELECT count(id_etsy_shipping_templates) as total FROM " . DB_PREFIX . "etsy_shipping_templates WHERE id_etsy_shipping_templates = '" . (int) $id_etsy_shipping_templates . "'";
        } else {
            $sql = "SELECT count(id_etsy_shipping_templates) as total FROM " . DB_PREFIX . "etsy_shipping_templates where id_etsy_shipping_templates > 0 and delete_flag = '0'";
        }
        if (isset($data['filter_shipping_name']) && !is_null($data['filter_shipping_name'])) {
            $sql .= " AND shipping_template_title LIKE '" . $this->db->escape($data['filter_shipping_name']) . "%'";
        }
    ...
    {
        $sql = "SELECT * FROM " . DB_PREFIX . "etsy_shipping_templates WHERE shipping_template_title = '" . $title . "'";
        $query = $this->db->query($sql);
        if ($query->num_rows > 0) {
            return true;
        }
    ...
    public function getShippingTemplateDetails($data, $id_etsy_shipping_templates = '', $fields_list = '*')
    {
        if (!empty($id_etsy_shipping_templates)) {
            $sql = "SELECT " . $fields_list . " FROM " . DB_PREFIX . "etsy_shipping_templates WHERE id_etsy_shipping_templates = '" . (int) $id_etsy_shipping_templates . "'";
        } else {
            $sql = "SELECT " . $fields_list . " FROM " . DB_PREFIX . "etsy_shipping_templates where id_etsy_shipping_templates > 0 and delete_flag = '0'";
        }
        if (isset($data['filter_shipping_name']) && !is_null($data['filter_shipping_name'])) {
            $sql .= " AND shipping_template_title LIKE '" . $this->db->escape($data['filter_shipping_name']) . "%'";
        }
        ...
        if (isset($data['sort']) && in_array($data['sort'], $sort_data)) {
            ...
            $sql .= " ORDER BY id_etsy_shipping_templates";
        }
    ...
    {
        $sql = "SELECT * FROM " . DB_PREFIX . "etsy_shipping_templates where delete_flag ='0'";
        $query = $this->db->query($sql);
        return $query->rows;
    }
    ...
    {
        $sql = "SELECT count(*) as count FROM " . DB_PREFIX . "etsy_shipping_templates_entries a "
                . " LEFT JOIN `" . DB_PREFIX . "etsy_shipping_templates` st ON (a.id_etsy_shipping_templates = st.id_etsy_shipping_templates) "
                . "WHERE a.delete_flag = '0'";
        if ($data['id_etsy_shipping_templates']) {
            $sql .= " AND a.id_etsy_shipping_templates='" . $data['id_etsy_shipping_templates'] . "'";
        }
        if (isset($data['filter_shipping_name']) && !is_null($data['filter_shipping_name'])) {
            $sql .= " AND shipping_template_title LIKE '" . $this->db->escape($data['filter_shipping_name']) . "%'";
        }
    ...
    {
        $sql = "SELECT * FROM " . DB_PREFIX . "etsy_shipping_templates_entries a "
                . "LEFT JOIN `" . DB_PREFIX . "etsy_shipping_templates` st "
                . "ON (a.id_etsy_shipping_templates = st.id_etsy_shipping_templates) "
                . "WHERE a.delete_flag = '0'";

        if (!empty($data['id_etsy_shipping_templates'])) {
            $sql .= " AND a.id_etsy_shipping_templates='" . $data['id_etsy_shipping_templates'] . "'";
        }

        if (!empty($data['id_etsy_shipping_templates_entries'])) {
            $sql .= " AND a.id_etsy_shipping_templates_entries='" . $data['id_etsy_shipping_templates_entries'] . "'";
        }
        ...
        if (isset($data['sort']) && in_array($data['sort'], $sort_data)) {
            ...
            $sql .= " ORDER BY a.id_etsy_shipping_templates_entries";
        }
    ...
    public function checkDestinationCountryExists($shipping_entry_destination_country_id, $id_etsy_shipping_templates, $id = '')
    {
        if (isset($id) && $id != '') {
            $sql = "SELECT * FROM " . DB_PREFIX . "etsy_shipping_templates_entries WHERE id_etsy_shipping_templates = '" . (int) $id_etsy_shipping_templates . "' AND id_etsy_shipping_templates_entries != " . (int) $id . " AND shipping_entry_destination_country_id = '" . $shipping_entry_destination_country_id . "'";
        } else {
            $sql = "SELECT * FROM " . DB_PREFIX . "etsy_shipping_templates_entries WHERE id_etsy_shipping_templates = " . (int) $id_etsy_shipping_templates . " AND shipping_entry_destination_country_id = '" . $shipping_entry_destination_country_id . "'";
        }
        $query = $this->db->query($sql);
        return $query->num_rows;
    }

    public function checkDestinationRegionExists($shipping_entry_destination_region_id, $id_etsy_shipping_templates, $id = '')
    {
        if (isset($id) && $id != '') {
            $sql = "SELECT * FROM " . DB_PREFIX . "etsy_shipping_templates_entries WHERE id_etsy_shipping_templates = '" . (int) $id_etsy_shipping_templates . "' AND id_etsy_shipping_templates_entries != " . (int) $id . " AND shipping_entry_destination_region_id = '" . $shipping_entry_destination_region_id . "'";
        } else {
            $sql = "SELECT * FROM " . DB_PREFIX . "etsy_shipping_templates_entries WHERE id_etsy_shipping_templates = " . (int) $id_etsy_shipping_templates . " AND shipping_entry_destination_region_id = '" . $shipping_entry_destination_region_id . "'";
        }
        $query = $this->db->query($sql);
        return $query->num_rows;
    }
