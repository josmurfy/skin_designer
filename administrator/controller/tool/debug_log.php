<?php
class ControllerToolDebugLog extends Controller {
	private $error = array();
	private $logfile = 'debug.txt';

	public function index() {
		$this->load->language('tool/debug_log');
		...
		$this->response->setOutput($this->load->view('tool/debug_log.tpl', $data));
	}

	public function clear() {
		$this->load->language('tool/debug_log');

		if (!$this->user->hasPermission('modify', 'tool/debug_log')) {
