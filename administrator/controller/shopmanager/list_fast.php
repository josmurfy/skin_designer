	...
	//	$this->document->addScript('view/javascript/fontawesome/css/fontawesome.css');
		...
		foreach ($results as $result) {
			...
			$data['products'][] = array(
				...
				'epid'   => $result['epid'],
				'has_sources'   => $result['has_sources'] ? ($lang['text_set'] ?? '') : ($lang['text_not_set'] ?? ''),
		...
		$data['text_epid_not_set'] = ($lang['text_epid_not_set'] ?? '');
		$data['text_epid_set'] = ($lang['text_epid_set'] ?? '');
		$data['text_epid_error'] = ($lang['text_epid_error'] ?? '');
		$data['text_select_product'] = ($lang['text_select_product'] ?? '');
		$data['text_location_placeholder'] = ($lang['text_location_placeholder'] ?? '');
		...
		$data['column_epid'] = ($lang['column_epid'] ?? '');
		...
		$data['entry_epid'] = ($lang['entry_epid'] ?? '');
