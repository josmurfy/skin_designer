...
class CardManufacturer extends \Opencart\System\Engine\Controller {
    ...
    public function add(): void {
        ...
        if ($this->request->server['REQUEST_METHOD'] == 'POST' && $this->validateForm()) {
            $manufacturer_id = $this->model_shopmanager_card_card_manufacturer->addManufacturer($this->request->post);
            ...
            $this->response->redirect(
                $this->url->link('shopmanager/card/card_manufacturer', 'user_token=' . $this->session->data['user_token'] . $this->buildUrlParams(), true)
            );
            return;
        }
    ...
    public function edit(): void {
        ...
        if ($this->request->server['REQUEST_METHOD'] == 'POST' && $this->validateForm()) {
            $this->model_shopmanager_card_card_manufacturer->editManufacturer(
    ...
    public function delete(): void {
        ...
        if (isset($this->request->post['selected'])) {
            foreach ($this->request->post['selected'] as $manufacturer_id) {
                $this->model_shopmanager_card_card_manufacturer->deleteManufacturer((int)$manufacturer_id);
            }
    ...
    public function search(): void {
        ...
        $manufacturers = $this->model_shopmanager_card_card_manufacturer->getManufacturers([
    ...
    protected function getList(): void {
        ...
        $total = $this->model_shopmanager_card_card_manufacturer->getTotalManufacturers([
            'filter_name'      => $filter_name,
            'filter_card_type' => $filter_card_type,
            'filter_status'    => $filter_status,
        ]);
        ...
        foreach ($manufacturers as $m) {
            $data['manufacturers'][] = [
                ...
                'edit'            => $this->url->link('shopmanager/card/card_manufacturer.edit', 'user_token=' . $this->session->data['user_token'] . '&manufacturer_id=' . $m['manufacturer_id'], true),
            ];
        }
        ...
        $data['pagination'] = $this->load->controller('common/pagination', [
            ...
            'page'  => $page,
            'limit' => $limit,
            'url'   => $this->url->link('shopmanager/card/card_manufacturer', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true)
        ]);
        ...
        // Urls
        $data['add']    = $this->url->link('shopmanager/card/card_manufacturer.add',    'user_token=' . $this->session->data['user_token'], true);
        $data['delete'] = $this->url->link('shopmanager/card/card_manufacturer.delete', 'user_token=' . $this->session->data['user_token'], true);
        ...
        $data['sort_name']       = $this->url->link('shopmanager/card/card_manufacturer', $url_base . '&sort=name&order='   . ($sort == 'name'   && $order == 'ASC' ? 'DESC' : 'ASC'), true);
        $data['sort_status']     = $this->url->link('shopmanager/card/card_manufacturer', $url_base . '&sort=status&order=' . ($sort == 'status' && $order == 'ASC' ? 'DESC' : 'ASC'), true);
        ...
        $this->response->setOutput($this->load->view('shopmanager/card/card_manufacturer_list', $data));
    }
    ...
    protected function getForm(): void {
        ...
        $manufacturer = [];
        if ($manufacturer_id) {
            $manufacturer = $this->model_shopmanager_card_card_manufacturer->getManufacturer($manufacturer_id);
        }
        ...
        if (isset($this->request->post['card_type_ids'])) {
            ...
            $data['selected_card_type_ids'] = $this->model_shopmanager_card_card_manufacturer->getManufacturerCardTypeIds($manufacturer_id);
        } else {
        ...
        // Action URLs
        if ($manufacturer_id) {
            $data['action'] = $this->url->link('shopmanager/card/card_manufacturer.edit', 'user_token=' . $this->session->data['user_token'] . '&manufacturer_id=' . $manufacturer_id, true);
        } else {
            $data['action'] = $this->url->link('shopmanager/card/card_manufacturer.add', 'user_token=' . $this->session->data['user_token'], true);
        }
        $data['cancel'] = $this->url->link('shopmanager/card/card_manufacturer', 'user_token=' . $this->session->data['user_token'], true);
        ...
        $this->response->setOutput($this->load->view('shopmanager/card/card_manufacturer_form', $data));
    }
