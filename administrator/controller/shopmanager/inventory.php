...
class Inventory extends \Opencart\System\Engine\Controller {
    ...
    public function index(): void {
        ...
        $this->document->addScript('view/javascript/shopmanager/inventory/location.js');
        ...
        $data['breadcrumbs'][] = [
            ...
            'href' => $this->url->link('shopmanager/inventory', 'user_token=' . $this->session->data['user_token'])
        ];
        ...
        // Action URLs
        $data['action_update'] = $this->url->link('shopmanager/inventory.updateLocation', 'user_token=' . $this->session->data['user_token']);
    ...
    protected function getList(): string {
        ...
        $data['sort_sku'] = $this->url->link('shopmanager/inventory.list', 'user_token=' . $this->session->data['user_token'] . '&sort=p.sku&order=' . $url_order . $url);
        $data['sort_name'] = $this->url->link('shopmanager/inventory.list', 'user_token=' . $this->session->data['user_token'] . '&sort=pd.name&order=' . $url_order . $url);
        $data['sort_quantity'] = $this->url->link('shopmanager/inventory.list', 'user_token=' . $this->session->data['user_token'] . '&sort=p.quantity&order=' . $url_order . $url);
        $data['sort_location'] = $this->url->link('shopmanager/inventory.list', 'user_token=' . $this->session->data['user_token'] . '&sort=p.location&order=' . $url_order . $url);
    ...
    public function updateQuantity(): void {
        ...
        if (!$this->user->hasPermission('modify', 'shopmanager/inventory')) {
        ...
        if ($this->request->server['REQUEST_METHOD'] == 'POST') {
            ...
            if (!empty($product_ids) && !empty($new_location)) {
                foreach ($product_ids as $product_id) {
                    ...
                    $product_info = $this->model_shopmanager_inventory->getProduct($product_id);
