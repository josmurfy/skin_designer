...
class ControllerExtensionShippingParcelforce48 extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/shipping/parcelforce_48', 'user_token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->link('extension/shipping/parcelforce_48', 'user_token=' . $this->session->data['token'], true);
