...
class ControllerExtensionOpenbay extends Controller {
	...
	public function items() {
		...
		if (in_array($filter_marketplace_account_id, $ebay_status)) {
			$filter_market_name = 'ebay';
			$filter_market_id = array_search($filter_marketplace_account_id, $ebay_status);
		}
		...
		if (in_array($filter_marketplace_account_id, $amazon_status)) {
			$filter_market_name = 'amazon';
			$filter_market_id = array_search($filter_marketplace_account_id, $amazon_status);
		}
		...
		if (in_array($filter_marketplace_account_id, $amazonus_status)) {
			$filter_market_name = 'amazonus';
			$filter_market_id = array_search($filter_marketplace_account_id, $amazonus_status);
		}
