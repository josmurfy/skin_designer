...
class ControllerExtensionDashboardSale extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/dashboard/sale', 'user_token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->link('extension/dashboard/sale', 'user_token=' . $this->session->data['token'], true);
	...
	public function dashboard() {
		...
		$data['sale'] = $this->url->link('sale/order', 'user_token=' . $this->session->data['token'], true);
