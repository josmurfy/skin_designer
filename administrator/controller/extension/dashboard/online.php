...
class ControllerExtensionDashboardOnline extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/dashboard/online', 'user_token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->link('extension/dashboard/online', 'user_token=' . $this->session->data['token'], true);
	...
	public function dashboard() {
		...
		$data['online'] = $this->url->link('report/customer_online', 'user_token=' . $this->session->data['token'], true);
