...
class ControllerExtensionDashboardRecent extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/dashboard/recent', 'user_token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->link('extension/dashboard/recent', 'user_token=' . $this->session->data['token'], true);
	...
	public function dashboard() {
		...
		foreach ($results as $result) {
			$data['orders'][] = array(
				...
				'view'       => $this->url->link('sale/order/info', 'user_token=' . $this->session->data['token'] . '&order_id=' . $result['order_id'], true),
			);
		}
