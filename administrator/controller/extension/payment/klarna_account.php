...
class ControllerExtensionPaymentKlarnaAccount extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/payment/klarna_account', 'user_token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->link('extension/payment/klarna_account', 'user_token=' . $this->session->data['token'], true);
		...
		$data['clear'] = $this->url->link('extension/payment/klarna_account/clear', 'user_token=' . $this->session->data['token'], true);
	...
	public function clear() {
		...
		$this->response->redirect($this->url->link('extension/payment/klarna_account', 'user_token=' . $this->session->data['token'], true));
	}
}