...
class ControllerExtensionPaymentEway extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/payment/eway', 'user_token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->link('extension/payment/eway', 'user_token=' . $this->session->data['token'], true);
