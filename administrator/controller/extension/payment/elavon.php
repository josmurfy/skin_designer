...
$data['entry_vmid'] = $this->language->get('entry_vmid');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/payment/elavon', 'user_token=' . $this->session->data['token'], true)
		);
		
		$data['action'] = $this->url->link('extension/payment/elavon', 'user_token=' . $this->session->data['token'], true);
