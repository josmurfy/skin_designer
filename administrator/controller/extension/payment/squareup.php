...
class ControllerExtensionPaymentSquareup extends Controller {
    ...
    protected function showForm() {
        ...
        try {
            ...
            if ($this->config->get('payment_squareup_access_token')) {
                if (false === $locations = $this->squareup_api->verifyToken($this->config->get('payment_squareup_access_token'), $first_location_id)) {
                    ...
                    $this->config->set('payment_squareup_apple_pay_status', 0);
                    $this->config->set('payment_squareup_google_pay_status', 0);
                    $this->config->set('payment_squareup_after_pay_status', 0);
                    $this->config->set('payment_squareup_gift_card_status', 0);
                } else {
                    ...
                    if ($this->config->get('payment_squareup_apple_pay_status')) {
        ...
        $data['payment_squareup_apple_pay_status']			= $this->getSettingValue('payment_squareup_apple_pay_status');
        $data['payment_squareup_google_pay_status']			= $this->getSettingValue('payment_squareup_google_pay_status');
        $data['payment_squareup_after_pay_status']			= $this->getSettingValue('payment_squareup_after_pay_status');
        $data['payment_squareup_gift_card_status']			= $this->getSettingValue('payment_squareup_gift_card_status');
		$data['payment_squareup_image_sync']				= $this->getSettingValue('payment_squareup_image_sync', '0');
        ...
        $data['initial_sync_not_performed']                 = !$this->config->get('payment_squareup_initial_sync');
