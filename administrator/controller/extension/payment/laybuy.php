...
class ControllerExtensionPaymentLaybuy extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/payment/laybuy', 'user_token=' . $this->session->data['token'], true)
		);
		...
		$data['action'] = $this->url->link('extension/payment/laybuy', 'user_token=' . $this->session->data['token'], true);

		$data['fetch'] = $this->url->link('extension/payment/laybuy/fetch', 'user_token=' . $this->session->data['token'] . '#reportstab', true);
		...
		foreach ($results as $result) {
			...
			if ($customer_id) {
				$customer_url = $this->url->link('customer/customer/edit', 'user_token=' . $this->session->data['token'] . '&customer_id=' . (int)$customer_id, true);
			}

			$data['reports'][] = array(
				'id'			=> $result['laybuy_transaction_id'],
				'order_id'		=> $result['order_id'],
				'order_url'		=> $this->url->link('sale/order/info', 'user_token=' . $this->session->data['token'] . '&order_id=' . (int)$result['order_id'], true),
				...
				'view'			=> $this->url->link('extension/payment/laybuy/transaction', 'user_token=' . $this->session->data['token'] . '&id=' . (int)$result['laybuy_transaction_id'], true)
			);
		}
		...
		$data['sort_order_id'] = $this->url->link('extension/payment/laybuy', 'user_token=' . $this->session->data['token'] . '&sort=lt.order_id' . $url . '#reportstab', true);
		$data['sort_customer'] = $this->url->link('extension/payment/laybuy', 'user_token=' . $this->session->data['token'] . '&sort=customer' . $url . '#reportstab', true);
		$data['sort_amount'] = $this->url->link('extension/payment/laybuy', 'user_token=' . $this->session->data['token'] . '&sort=lt.amount' . $url . '#reportstab', true);
		$data['sort_dp_percent'] = $this->url->link('extension/payment/laybuy', 'user_token=' . $this->session->data['token'] . '&sort=lt.downpayment' . $url . '#reportstab', true);
		$data['sort_months'] = $this->url->link('extension/payment/laybuy', 'user_token=' . $this->session->data['token'] . '&sort=lt.months' . $url . '#reportstab', true);
		$data['sort_dp_amount'] = $this->url->link('extension/payment/laybuy', 'user_token=' . $this->session->data['token'] . '&sort=lt.downpayment_amount' . $url . '#reportstab', true);
		$data['sort_first_payment'] = $this->url->link('extension/payment/laybuy', 'user_token=' . $this->session->data['token'] . '&sort=lt.first_payment_due' . $url . '#reportstab', true);
		$data['sort_last_payment'] = $this->url->link('extension/payment/laybuy', 'user_token=' . $this->session->data['token'] . '&sort=lt.last_payment_due' . $url . '#reportstab', true);
		$data['sort_status'] = $this->url->link('extension/payment/laybuy', 'user_token=' . $this->session->data['token'] . '&sort=lt.status' . $url . '#reportstab', true);
		$data['sort_date_added'] = $this->url->link('extension/payment/laybuy', 'user_token=' . $this->session->data['token'] . '&sort=lt.date_added' . $url . '#reportstab', true);
		...
		$pagination->url = $this->url->link('extension/payment/laybuy', 'user_token=' . $this->session->data['token'] . $url . '&page={page}#reportstab', true);
	...
	public function fetch() {
		...
		if ($this->user->hasPermission('modify', 'extension/payment/laybuy')) {
			...
			if ($paypal_profile_id_array) {
				...
				$this->response->redirect($this->url->link('extension/payment/laybuy', 'user_token=' . $this->session->data['token'], true));
			} else {
	...
	public function transaction($order_page = false) {
		...
		$data['breadcrumbs'][] = array(
			'text' => $this->language->get('heading_title'),
			'href' => $this->url->link('extension/payment/laybuy', 'user_token=' . $this->session->data['token'] . '#reportstab', true)
		);

		$data['breadcrumbs'][] = array(
			'text' => $this->language->get('heading_transaction_title'),
			'href' => $this->url->link('extension/payment/laybuy/transaction', 'user_token=' . $this->session->data['token'] . '&id=' . $id, true)
		);
		...
		$data['cancel'] = $this->url->link('extension/payment/laybuy', 'user_token=' . $this->session->data['token'] . '#reportstab', true);
	...
	public function cancel() {
		...
		if ($this->user->hasPermission('modify', 'extension/payment/laybuy')) {
			...
			if ($this->request->get['source'] == 'order') {
				...
				$json['reload'] = $this->url->link('extension/payment/laybuy/transaction', 'user_token=' . $this->session->data['token'] . '&id=' . $id, true);
			}
