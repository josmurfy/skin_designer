	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			if (isset($this->request->post['language_reload'])) {
				$this->response->redirect($this->url->link('payment/amazon_login_pay', 'user_token=' . $this->session->data['token'], true));
			} else {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/payment/amazon_login_pay', 'user_token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->link('extension/payment/amazon_login_pay', 'user_token=' . $this->session->data['token'], true);
