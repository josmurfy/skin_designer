...
class ControllerExtensionPaymentPPPayflowIframe extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/payment/pp_payflow_iframe', 'user_token=' . $this->session->data['token'], true),
		);

		$data['action'] = $this->url->link('extension/payment/pp_payflow_iframe', 'user_token=' . $this->session->data['token'], true);
	...
	public function refund() {
		...
		if ($transaction) {
			...
			$data['cancel'] = $this->url->link('sale/order/info', 'user_token=' . $this->session->data['token'] . '&order_id=' . $transaction['order_id'], true);
