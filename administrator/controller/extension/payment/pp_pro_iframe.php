...
class ControllerExtensionPaymentPPProIframe extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/payment/pp_pro_iframe', 'user_token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->link('extension/payment/pp_pro_iframe', 'user_token=' . $this->session->data['token'], true);
	...
	public function order() {
		...
		if ($paypal_order) {
			...
			$data['view_link'] = $this->url->link('extension/payment/pp_pro_iframe/info', 'user_token=' . $this->session->data['token'], true);
			$data['refund_link'] = $this->url->link('extension/payment/pp_pro_iframe/refund', 'user_token=' . $this->session->data['token'], true);
			$data['resend_link'] = $this->url->link('extension/payment/pp_pro_iframe/resend', 'user_token=' . $this->session->data['token'], true);
			...
			foreach ($paypal_order['transactions'] as $transaction) {
				$data['transactions'][] = array(
					...
					'view' => $this->url->link('extension/payment/pp_pro_iframe/info', 'user_token=' . $this->session->data['token'] . "&transaction_id=" . $transaction['transaction_id'] . '&order_id=' . $this->request->get['order_id'], true),
					'refund' => $this->url->link('extension/payment/pp_pro_iframe/refund', 'user_token=' . $this->session->data['token'] . "&transaction_id=" . $transaction['transaction_id'] . "&order_id=" . $this->request->get['order_id'], true),
					'resend' => $this->url->link('extension/payment/pp_pro_iframe/resend', 'user_token=' . $this->session->data['token'] . "&paypal_iframe_order_transaction_id=" . $transaction['paypal_iframe_order_transaction_id'], true),
				);
			}

			$data['reauthorise_link'] = $this->url->link('extension/payment/pp_pro_iframe/reauthorise', 'user_token=' . $this->session->data['token'], true);
	...
	public function refund() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/payment/pp_pro_iframe/refund', 'user_token=' . $this->session->data['token'], true)
		);

		//button actions
		$data['action'] = $this->url->link('extension/payment/pp_pro_iframe/doRefund', 'user_token=' . $this->session->data['token'], true);

		if (isset($this->request->get['order_id'])) {
			$data['cancel'] = $this->url->link('sale/order/info', 'user_token=' . $this->session->data['token'] . '&order_id=' . $this->request->get['order_id'], true);
		} else {
			$data['cancel'] = '';
		}
	...
	public function doRefund() {
		...
		if (isset($this->request->post['transaction_id']) && isset($this->request->post['refund_full'])) {
			...
			if ($this->request->post['refund_full'] == 0 && $this->request->post['amount'] == 0) {
				...
				$this->response->redirect($this->url->link('extension/payment/pp_pro_iframe/refund', 'user_token=' . $this->session->data['token'] . '&transaction_id=' . $this->request->post['transaction_id'], true));
			} else {
	...
	public function info() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/payment/pp_pro_iframe/info', 'user_token=' . $this->session->data['token'] . '&transaction_id=' . $this->request->get['transaction_id'], true)
		);
		...
		if (isset($this->request->get['order_id'])) {
			$data['back'] = $this->url->link('sale/order/info', 'user_token=' . $this->session->data['token'] . '&order_id=' . $this->request->get['order_id'], true);
		} else {
			$data['back'] = '';
		}
