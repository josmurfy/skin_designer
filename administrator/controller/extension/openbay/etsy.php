...
class ControllerExtensionOpenbayEtsy extends Controller {
	...
	public function index() {
		...
		$data['links_settings'] = $this->url->link('extension/openbay/etsy/settings', 'user_token=' . $this->session->data['token'], true);
		$data['links_products'] = $this->url->link('extension/openbay/etsy_product/links', 'user_token=' . $this->session->data['token'], true);
		$data['links_listings'] = $this->url->link('extension/openbay/etsy_product/listings', 'user_token=' . $this->session->data['token'], true);
	...
	public function settings() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && ($this->validate())) {
			...
			$this->response->redirect($this->url->link('extension/openbay/etsy', 'user_token=' . $this->session->data['token'], true));
		}
		...
		$data['breadcrumbs'][] = array(
			'href' => $this->url->link('extension/openbay/etsy/settings', 'user_token=' . $this->session->data['token'], true),
			'text' => $this->language->get('heading_title'),
		);

		$data['action'] = $this->url->link('extension/openbay/etsy/settings', 'user_token=' . $this->session->data['token'], true);
		$data['cancel'] = $this->url->link('extension/openbay/etsy', 'user_token=' . $this->session->data['token'], true);
