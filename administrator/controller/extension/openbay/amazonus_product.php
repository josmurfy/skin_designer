...
class ControllerExtensionOpenbayAmazonusProduct extends Controller{
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			'href' => $this->url->link('extension/openbay/amazonus_listing/create', 'user_token=' . $this->session->data['token'], true),
			'text' => $this->language->get('heading_title'),
		);

		$data['breadcrumbs'][] = array(
			'href' => $this->url->link('extension/openbay/amazonus_product', 'user_token=' . $this->session->data['token'], true),
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			if ($data_array['upload_after'] === 'true') {
				...
				$this->response->redirect($this->url->link('extension/openbay/amazonus_product', 'user_token=' . $this->session->data['token'] . '&product_id=' . $product_id . $url, true));
			}
		}
		...
		$data['listing_url'] = $this->url->link('catalog/product/edit', 'user_token=' . $this->session->data['token'] . '&product_id=' . $product_id . $url, true);
		...
		if ($listing_saved) {
			$data['template_parser_url'] = $this->url->link('extension/openbay/amazonus_product/parseTemplateAjax&edit_id=' . $product_id, 'user_token=' . $this->session->data['token'], true);
		} else {
			$data['template_parser_url'] = $this->url->link('extension/openbay/amazonus_product/parseTemplateAjax&product_id=' . $product_id, 'user_token=' . $this->session->data['token'], true);
		}

		$data['url_remove_errors'] = $this->url->link('extension/openbay/amazonus_product/removeErrors', 'user_token=' . $this->session->data['token'] . '&product_id=' . $product_id . $url, true);
		$data['cancel_url'] = $this->url->link('extension/openbay/items', 'user_token=' . $this->session->data['token'] . $url, true);
		$data['saved_listings_url'] = $this->url->link('extension/openbay/amazonus/savedListings', 'user_token=' . $this->session->data['token'], true);
		$data['main_url'] = $this->url->link('extension/openbay/amazonus_product', 'user_token=' . $this->session->data['token'] . $url, true);
