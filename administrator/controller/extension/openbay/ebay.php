...
class ControllerExtensionOpenbayEbay extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			'href' => $this->url->link('extension/openbay/ebay', 'user_token=' . $this->session->data['token'], true),
		...
		$data['links_settings']           = $this->url->link('extension/openbay/ebay/settings', 'user_token=' . $this->session->data['token'], true);
		$data['links_itemlink']           = $this->url->link('extension/openbay/ebay/viewItemLinks', 'user_token=' . $this->session->data['token'], true);
		$data['links_subscribe']          = $this->url->link('extension/openbay/ebay/subscription', 'user_token=' . $this->session->data['token'], true);
		$data['links_usage']          	  = $this->url->link('extension/openbay/ebay/viewUsage', 'user_token=' . $this->session->data['token'], true);
		$data['links_itemimport']         = $this->url->link('extension/openbay/ebay/viewItemImport', 'user_token=' . $this->session->data['token'], true);
		$data['links_orderimport']        = $this->url->link('extension/openbay/ebay/viewOrderImport', 'user_token=' . $this->session->data['token'], true);
		$data['links_usage']              = $this->url->link('extension/openbay/ebay/viewUsage', 'user_token=' . $this->session->data['token'], true);
		$data['links_sync']               = $this->url->link('extension/openbay/ebay/syncronise', 'user_token=' . $this->session->data['token'], true);
		$data['links_linkmaintenance']    = $this->url->link('extension/openbay/ebay/viewItemLinkMaintenance', 'user_token=' . $this->session->data['token'], true);
		$data['links_summary']            = $this->url->link('extension/openbay/ebay/summary', 'user_token=' . $this->session->data['token'], true);
		$data['links_profile']            = $this->url->link('extension/openbay/ebay_profile/profileAll', 'user_token=' . $this->session->data['token'], true);
		$data['links_template']           = $this->url->link('extension/openbay/ebay_template/listAll', 'user_token=' . $this->session->data['token'], true);
	...
	public function settings() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && ($this->validate())) {
			...
			$this->response->redirect($this->url->link('extension/openbay/ebay', 'user_token=' . $this->session->data['token'], true));
		}
		...
		$data['breadcrumbs'][] = array(
			'href' => $this->url->link('extension/openbay/ebay/settings', 'user_token=' . $this->session->data['token'], true),
			'text' => $this->language->get('heading_title'),
		);

		$data['action'] = $this->url->link('extension/openbay/ebay/settings', 'user_token=' . $this->session->data['token'], true);
		$data['cancel'] = $this->url->link('extension/openbay/ebay', 'user_token=' . $this->session->data['token'], true);
	...
	public function getCategorySpecifics() {
		...
		$response = $this->model_extension_openbay_ebay->getCategorySpecifics($this->request->get['category_id']);
	...
	public function summary() {
		...
		$data['breadcrumbs'][] = array(
			'href' => $this->url->link('extension/openbay/ebay/summary', 'user_token=' . $this->session->data['token'], true),
			'text' => $data['heading_title'],
		);

		$data['return'] = $this->url->link('extension/openbay/ebay', 'user_token=' . $this->session->data['token'], true);
		$data['validation'] = $this->openbay->ebay->validate();
		$data['token'] = $this->session->data['token'];
	...
	public function viewItemImport() {
		...
		$data['breadcrumbs'][] = array(
			'href' => $this->url->link('extension/openbay/ebay/viewItemImport', 'user_token=' . $this->session->data['token'], true),
			'text' => $this->language->get('heading_title'),
		);
		...
		$data['image_import_link'] = $this->url->link('extension/openbay/ebay/getImportImages', 'user_token=' . $this->session->data['token'], true);
	...
	public function subscription() {
		...
		$data['breadcrumbs'][] = array(
			'href' => $this->url->link('extension/openbay/ebay/subscription', 'user_token=' . $this->session->data['token'], true),
			'text' => $this->language->get('heading_title'),
		);
	...
	public function viewUsage() {
		...
		$data['breadcrumbs'][] = array(
			'href' => $this->url->link('extension/openbay/ebay/view_usage', 'user_token=' . $this->session->data['token'], true),
			'text' => $this->language->get('heading_title'),
		);
	...
	public function viewOrderImport() {
		...
		$data['breadcrumbs'][] = array(
			'href' => $this->url->link('extension/openbay/ebay/viewOrderImport', 'user_token=' . $this->session->data['token'], true),
			'text' => $this->language->get('heading_title'),
		);
	...
	public function syncronise() {
		...
		$data['breadcrumbs'][] = array(
			'href' => $this->url->link('extension/openbay/ebay/syncronise', 'user_token=' . $this->session->data['token'], true),
			'text' => $this->language->get('heading_title'),
		);
	...
	public function viewItemLinks() {
		...
		$data['breadcrumbs'][] = array(
			'href' => $this->url->link('extension/openbay/ebay/viewItemLinks', 'user_token=' . $this->session->data['token'], true),
			'text' => $this->language->get('heading_title'),
		);

		$data['cancel']       = $this->url->link('extension/openbay/ebay', 'user_token=' . $this->session->data['token'], true);
		$data['edit_url']     = $this->url->link('extension/openbay/ebay/edit', 'user_token=' . $this->session->data['token'] . '&product_id=', true);
		$data['validation']   = $this->openbay->ebay->validate();
		$data['token']        = $this->session->data['token'];
		...
		$pagination->url = $this->url->link('extension/openbay/ebay/viewItemLinks', 'user_token=' . $this->session->data['token'] . '&linked_item_page={page}', true);
	...
	public function edit() {
		if ($this->checkConfig() == true) {
			if (!empty($this->request->get['product_id'])) {
				...
				$data['action'] = $this->url->link('extension/openbay/ebay/create', 'user_token=' . $this->session->data['token'], true);
				$data['cancel'] = $this->url->link('extension/openbay/items', 'user_token=' . $this->session->data['token'], true);
				...
				$data['breadcrumbs'][] = array(
					'href' => $this->url->link('extension/openbay/ebay/edit', 'user_token=' . $this->session->data['token'] . '&product_id=' . $this->request->get['product_id'], true),
					'text' => $this->language->get('heading_title'),
				);
				...
				$this->response->redirect($this->url->link('extension/openbay/items', 'user_token=' . $this->session->data['token'], true));
			}
		}
	}
	...
	public function create() {
		if ($this->checkConfig() == true) {
			if (!empty($this->request->get['product_id'])) {
				...
				$data['breadcrumbs'][] = array(
					'href'      => $this->url->link('extension/openbay/ebay/create', 'user_token=' . $this->session->data['token'] . '&product_id=' . $this->request->get['product_id'], true),
					'text'      => $this->language->get('heading_title'),
				);
				...
				//post edit link
				$product_info['edit_link'] = $this->url->link('extension/openbay/ebay/edit', 'user_token=' . $this->session->data['token'] . '&product_id=' . $this->request->get['product_id'], true);
	...
	public function createBulk() {
		if ($this->checkConfig() == true) {
			if (!empty($this->request->post['selected'])) {
				...
				$data['breadcrumbs'][] = array(
					'href'      => $this->url->link('extension/openbay/ebay/createBulk', 'user_token=' . $this->session->data['token'], true),
					'text'      => $this->language->get('heading_title'),
				);
				...
				if ($plan['plan']['listing_bulk'] == 1) {
					if ($data['count'] == 0) {
						...
						if (($plan['plan']['listing_limit'] == 0) || (($plan['usage']['items'] + $data['count']) <= $plan['plan']['listing_limit'])) {
							...
							$data['error_fail']['plan'] = sprintf($this->language->get('text_item_limit'), $this->url->link('extension/openbay/ebay/subscription', 'user_token=' . $this->session->data['token'], true));
						}
					}
				} else {
					$data['error_fail']['plan'] = sprintf($this->language->get('text_bulk_plan_error'), $this->url->link('extension/openbay/ebay/subscription', 'user_token=' . $this->session->data['token'], true));
				}
