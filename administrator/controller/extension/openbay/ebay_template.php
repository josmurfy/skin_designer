...
class ControllerExtensionOpenbayEbayTemplate extends Controller {
	...
	public function listAll() {
		...
		$data['add'] = $this->url->link('extension/openbay/ebay_template/add', 'user_token=' . $this->session->data['token'], true);
		...
		$data['breadcrumbs'][] = array(
			'href' => $this->url->link('extension/openbay/ebay_template/listAll', 'user_token=' . $this->session->data['token'], true),
	...
	public function add() {
		...
		$data['btn_save']     = $this->url->link('extension/openbay/ebay_template/add', 'user_token=' . $this->session->data['token'], true);
		$data['cancel']       = $this->url->link('extension/openbay/ebay_template/listAll', 'user_token=' . $this->session->data['token'], true);
		...
		if ($this->request->post && $this->templateValidate()) {
			...
			$this->response->redirect($this->url->link('extension/openbay/ebay_template/listAll', 'user_token=' . $this->session->data['token'], true));
		}
	...
	public function edit() {
		...
		$data['btn_save']     = $this->url->link('extension/openbay/ebay_template/edit', 'user_token=' . $this->session->data['token'], true);
		$data['cancel']       = $this->url->link('extension/openbay/ebay_template/listAll', 'user_token=' . $this->session->data['token'], true);
