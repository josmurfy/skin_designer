...
class ControllerExtensionOpenbayAmazon extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			'href'      => $this->url->link('extension/openbay', 'user_token=' . $this->session->data['token'], true),
			'text'      => $this->language->get('text_openbay'),
		);
		$data['breadcrumbs'][] = array(
			'href'      => $this->url->link('extension/openbay/amazon', 'user_token=' . $this->session->data['token'], true),
		...
		$data['link_settings'] = $this->url->link('extension/openbay/amazon/settings', 'user_token=' . $this->session->data['token'], true);
		$data['link_subscription'] = $this->url->link('extension/openbay/amazon/subscription', 'user_token=' . $this->session->data['token'], true);
		$data['link_item_link'] = $this->url->link('extension/openbay/amazon/itemLinks', 'user_token=' . $this->session->data['token'], true);
		$data['link_stock_updates'] = $this->url->link('extension/openbay/amazon/stockUpdates', 'user_token=' . $this->session->data['token'], true);
		$data['link_saved_listings'] = $this->url->link('extension/openbay/amazon/savedListings', 'user_token=' . $this->session->data['token'], true);
		$data['link_bulk_listing'] = $this->url->link('extension/openbay/amazon/bulkListProducts', 'user_token=' . $this->session->data['token'], true);
		$data['link_bulk_linking'] = $this->url->link('extension/openbay/amazon/bulklinking', 'user_token=' . $this->session->data['token'], true);
	...
	public function stockUpdates() {
		...
		$data['breadcrumbs'][] = array(
			'href'      => $this->url->link('extension/openbay/amazon/stockUpdates', 'user_token=' . $this->session->data['token'], true),
			'text'      => $this->language->get('heading_title'),
		);

		$data['link_overview'] = $this->url->link('extension/openbay/amazon', 'user_token=' . $this->session->data['token'], true);
	...
	public function subscription() {
		...
		$data['breadcrumbs'][] = array(
			'href'      => $this->url->link('extension/openbay/amazon/subscription', 'user_token=' . $this->session->data['token'], true),
			'text'      => $this->language->get('heading_title'),
		);
	...
	public function settings() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('extension/openbay/amazon', 'user_token=' . $this->session->data['token'], true));
			return;
		}

		$data['cancel'] = $this->url->link('extension/openbay/amazon', 'user_token=' . $this->session->data['token'], true);
		...
		$data['breadcrumbs'][] = array(
			'href'      => $this->url->link('extension/openbay/amazon/settings', 'user_token=' . $this->session->data['token'], true),
			'text'      => $this->language->get('heading_title'),
		);
		...
		$data['subscription_url'] = $this->url->link('extension/openbay/amazon/subscription', 'user_token=' . $this->session->data['token'], true);
		$data['itemLinks_url'] = $this->url->link('extension/openbay/amazon_product/linkItems', 'user_token=' . $this->session->data['token'], true);
	...
	public function itemLinks() {
		...
		$data['breadcrumbs'][] = array(
			'href'      => $this->url->link('extension/openbay/amazon/itemLinks', 'user_token=' . $this->session->data['token'], true),
			'text'      => $this->language->get('heading_title'),
		);
		...
		$data['link_add_item'] = $this->url->link('extension/openbay/amazon/addLink', 'user_token=' . $this->session->data['token'], true);
		$data['link_remove_item'] = $this->url->link('extension/openbay/amazon/deleteLink', 'user_token=' . $this->session->data['token'], true);
		$data['link_get_items'] = $this->url->link('extension/openbay/amazon/getLinks', 'user_token=' . $this->session->data['token'], true);
		$data['link_get_unlinked_items'] = $this->url->link('extension/openbay/amazon/getUnlinked', 'user_token=' . $this->session->data['token'], true);
		$data['link_get_variants'] = $this->url->link('extension/openbay/amazon/getVariants', 'user_token=' . $this->session->data['token'], true);
	...
	public function savedListings() {
		...
		$data['breadcrumbs'][] = array(
			'href'      => $this->url->link('extension/openbay/amazon/savedListings', 'user_token=' . $this->session->data['token'], true),
			'text'      => $this->language->get('heading_title'),
		);
		...
		foreach($saved_products as $saved_product) {
			$data['saved_products'][] = array(
				...
				'edit_link' => $this->url->link('extension/openbay/amazon_product', 'user_token=' . $this->session->data['token'] . '&product_id=' . $saved_product['product_id'] . '&sku=' . $saved_product['var'], true),
			);
		}

		$data['delete_saved'] = $this->url->link('extension/openbay/amazon_product/deleteSaved', 'user_token=' . $this->session->data['token'], true);
		$data['upload_saved'] = $this->url->link('extension/openbay/amazon_product/uploadSaved', 'user_token=' . $this->session->data['token'], true);
	...
	public function bulkListProducts() {
		...
		$data['breadcrumbs'][] = array(
			'href'      => $this->url->link('extension/openbay/amazon/bulkListProducts', 'user_token=' . $this->session->data['token'], true),
			'text'      => $this->language->get('heading_title'),
		);
		...
		if (!empty($this->request->get['filter_marketplace_account_id'])) {
			$filter_marketplace_account_id = $this->request->get['filter_marketplace_account_id'];
		} else {
			$filter_marketplace_account_id = $this->config->get('openbay_amazon_default_listing_marketplace');
		}
		...
		if ($bulk_listing_status) {
			$data['link_search'] = $this->url->link('extension/openbay/amazon/doBulkSearch', 'user_token=' . $this->session->data['token'], true);
			...
			$filter['filter_marketplace_account_id'] = $filter_marketplace_account_id;
			...
			foreach ($results as $result) {
				...
				$href = $this->url->link('catalog/product/edit', 'user_token=' . $this->session->data['token'] . '&product_id=' . $product['product_id'], true);
			...
			$pagination->url = $this->url->link('extension/openbay/amazon/bulkListProducts', 'user_token=' . $this->session->data['token'] . '&page={page}&filter_marketplace_account_id=' . $filter_marketplace_account_id, true);
	...
	public function bulkLinking() {
		...
		$data['breadcrumbs'][] = array(
			'href'      => $this->url->link('extension/openbay/amazon/bulklinking', 'user_token=' . $this->session->data['token'], true),
			'text'      => $this->language->get('heading_title'),
		);
		...
		$marketplaces = array(
			'uk' => array(
				...
				'code' => 'uk',
				'href_load_listings' => $this->url->link('extension/openbay/amazon/loadListingReport', 'user_token=' . $this->session->data['token'] . '&marketplace=uk', true),
				'link' => $this->url->link('extension/openbay/amazon/bulklinking', 'user_token=' . $this->session->data['token'] . '&marketplace=uk', true),
			),
			'de' => array(
				'name' => $this->language->get('text_de'),
				'code' => 'de',
				'href_load_listings' => $this->url->link('extension/openbay/amazon/loadListingReport', 'user_token=' . $this->session->data['token'] . '&marketplace=de', true),
				'link' => $this->url->link('extension/openbay/amazon/bulklinking', 'user_token=' . $this->session->data['token'] . '&marketplace=de', true),
			),
			'fr' => array(
				'name' => $this->language->get('text_fr'),
				'code' => 'fr',
				'href_load_listings' => $this->url->link('extension/openbay/amazon/loadListingReport', 'user_token=' . $this->session->data['token'] . '&marketplace=fr', true),
				'link' => $this->url->link('extension/openbay/amazon/bulklinking', 'user_token=' . $this->session->data['token'] . '&marketplace=fr', true),
			),
			'it' => array(
				'name' => $this->language->get('text_it'),
				'code' => 'it',
				'href_load_listings' => $this->url->link('extension/openbay/amazon/loadListingReport', 'user_token=' . $this->session->data['token'] . '&marketplace=it', true),
				'link' => $this->url->link('extension/openbay/amazon/bulklinking', 'user_token=' . $this->session->data['token'] . '&marketplace=it', true),
			),
			'es' => array(
				'name' => $this->language->get('text_es'),
				'code' => 'es',
				'href_load_listings' => $this->url->link('extension/openbay/amazon/loadListingReport', 'user_token=' . $this->session->data['token'] . '&marketplace=es', true),
				'link' => $this->url->link('extension/openbay/amazon/bulklinking', 'user_token=' . $this->session->data['token'] . '&marketplace=es', true),
			),
		);
		...
		$pagination->text = $this->language->get('text_pagination');
		$pagination->url = $this->url->link('extension/openbay/amazon/bulklinking', 'user_token=' . $this->session->data['token'] . '&linked_item_page={page}&marketplace=' . $marketplace_code, true);
		...
		foreach ($results as $result) {
			$products[] = array(
				...
				'var' => $result['var'],
				'href_product' => $this->url->link('catalog/product/edit', 'user_token=' . $this->session->data['token'] . '&product_id=' . $result['product_id'], true),
			);
		}
		...
		$data['cancel'] = $this->url->link('extension/openbay/amazon', 'user_token=' . $this->session->data['token'], true);
		$data['link_do_listings'] = $this->url->link('extension/openbay/amazon/doBulkLinking', 'user_token=' . $this->session->data['token'], true);
		$data['token'] = $this->session->data['token'];
