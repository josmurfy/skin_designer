...
class ControllerExtensionOpenbayAmazon extends Controller {
	...
	public function bulkListProducts() {
		...
		if ($bulk_listing_status) {
			...
			$pagination->url = $this->url->link('extension/openbay/amazon/bulkListProducts', 'token=' . $this->session->data['token'] . '&page={page}&filter_marketplace_account_id=' . $filter_marketplace_account_id, true);
