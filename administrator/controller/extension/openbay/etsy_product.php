...
class ControllerExtensionOpenbayEtsyProduct extends Controller {
	...
	public function create() {
		...
		$data['action']   = $this->url->link('extension/openbay/etsy_product/create', 'user_token=' . $this->session->data['token'], true);
		...
		$data['breadcrumbs'][] = array(
			'href' => $this->url->link('extension/openbay/etsy', 'user_token=' . $this->session->data['token'], true),
			'text' => $this->language->get('text_etsy'),
		);
		$data['breadcrumbs'][] = array(
			'href' => $this->url->link('extension/openbay/etsy_product/create', 'user_token=' . $this->session->data['token'], true),
	...
	public function edit() {
		...
		$data['action']   = $this->url->link('extension/openbay/etsy_product/editSubmit', 'user_token=' . $this->session->data['token'], true);
		$data['cancel']   = $this->url->link('extension/openbay/items', 'user_token=' . $this->session->data['token'], true);
		$data['token']    = $this->session->data['token'];
		...
		$data['breadcrumbs'][] = array(
			'href' => $this->url->link('extension/openbay/etsy_product/edit', 'user_token=' . $this->session->data['token'] . '&product_id=' . $this->request->get['product_id'], true),
			'text' => $this->language->get('heading_title'),
		);
	...
	public function links() {
		...
		$data['breadcrumbs'][] = array(
			'href' => $this->url->link('extension/openbay/etsy_product/itemLinks', 'user_token=' . $this->session->data['token'], true),
			'text' => $this->language->get('heading_title'),
		);

		$data['return']       = $this->url->link('extension/openbay/etsy', 'user_token=' . $this->session->data['token'], true);
		...
		$pagination->url = $this->url->link('extension/openbay/etsy/itemLinks', 'user_token=' . $this->session->data['token'] . '&page={page}', true);
	...
	public function listings() {
		...
		if (isset($response['data']['error'])) {
			...
			$pagination->url = $this->url->link('extension/openbay/etsy_product/listings', 'user_token=' . $this->session->data['token'] . '&page={page}&' . http_build_query($filter), true);
