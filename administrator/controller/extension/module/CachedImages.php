...
class ControllerExtensionModuleCachedImages extends Controller {
	...
	public function deleteCachedImages() {
		...
		$this->response->redirect($this->url->link('extension/module/CachedImages', 'user_token=' . $this->session->data['token'] . '&type=module', true));
    }
	...
	public function index() {
		...
		$data['delete_cached_image'] = $this->url->link('extension/module/CachedImages/deleteCachedImages', 'user_token=' . $this->session->data['token'], true);
		...
		if (!isset($this->request->get['module_id'])) {
			$data['breadcrumbs'][] = array(
				...
				'href' => $this->url->link('extension/module/CachedImages', 'user_token=' . $this->session->data['token'], true)
			);
		} else {
			$data['breadcrumbs'][] = array(
				'text' => $this->language->get('heading_title'),
				'href' => $this->url->link('extension/module/CachedImages', 'user_token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], true)
			);
		}

		if (!isset($this->request->get['module_id'])) {
			$data['action'] = $this->url->link('extension/module/CachedImages', 'user_token=' . $this->session->data['token'], true);
		} else {
			$data['action'] = $this->url->link('extension/module/CachedImages', 'user_token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], true);
		}
