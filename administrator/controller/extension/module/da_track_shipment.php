...
class ControllerExtensionModuleDaTrackShipment extends Controller
{
    ...
    public function index() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/module/da_track_shipment', 'user_token=' . $this->session->data['token'], true),
            'separator' => ' :: '
        );
        $data['action'] = $this->url->link('extension/module/da_track_shipment', 'user_token=' . $this->session->data['token'], true);
