(function($) {
    ...
    let $deactivateForm  = jQuery('#pinterest-feed-deactivateForm');
    ...
    let deactivateFormSubmitted = localStorage.getItem('pinterest-feed-deactivateFormSubmitted');
    ...
    function submitForm(deactivate_options, id) {
        ...
        data.push({name: 'action', value: 'pinterest-feed-deactivate'});
        ...
        if (!deactivateFormSubmitted) {
            localStorage.setItem('pinterest-feed-deactivateFormSubmitted', true);
            deactivateFormSubmitted = true;

            jQuery.post('./controller/extension/module/elfsight_pinterest_feed.php', jQuery.param(data)).then(function(result) {
