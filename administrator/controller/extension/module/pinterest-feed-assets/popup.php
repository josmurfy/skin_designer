<link rel="stylesheet" href="./controller/extension/module/pinterest-feed-assets/popup.css">

<div class="eapps-deactivation-popup-overlay"></div>

<div class="eapps-deactivation-popup">
    <form method="post" id="pinterest-feed-deactivateForm" action="">
        <div class="eapps-deactivation-popup-header">
            <div class="eapps-deactivation-popup-header-heading">You have succesfully uninstalled Elfsight Pinterest Feed</div>
...
<script>
    ...
    node.async = true;
    node.src = './controller/extension/module/pinterest-feed-assets/popup.js';
