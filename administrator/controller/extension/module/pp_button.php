...
class ControllerExtensionModulePPButton extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/pp_button', 'user_token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->link('extension/module/pp_button', 'user_token=' . $this->session->data['token'], true);
