...
class Deactivate {
    ...
    public function __construct($data) {
        ...
        $this->app_slug = 'pinterest-feed';
        $this->app_name = 'Pinterest Feed';
    ...
    public function setDeactivateReasons() {
        return require ( (__DIR__) . '/pinterest-feed-assets/reasons.php' );
    }
...
class ControllerExtensionModuleElfsightPinterestFeed extends Controller {
	private $error = array();

	public $params = NULL;

    public $ELFSIGHT_EMBED_URL = 'https://apps.elfsight.com/embed/pinterest-feed/?utm_source=portals&utm_medium=opencart&utm_campaign=pinterest-feed&utm_content=sign-up';
	...
	public function index() {
		$this->load->language('extension/module/elfsight_pinterest_feed');
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			$this->model_setting_setting->editSetting('module_elfsight_pinterest_feed', $this->request->post);
		...
		if (isset($this->request->post['module_elfsight_pinterest_feed_status'])) {
			...
			$data['module_elfsight_pinterest_feed_status'] = $this->config->get('module_elfsight_pinterest_feed_status');
		}

		$data['header'] = $this->load->controller('common/header');
		$data['column_left'] = $this->load->controller('common/column_left');

		$this->response->setOutput($this->load->view('extension/module/elfsight_pinterest_feed', $data));
	}

	protected function validate() {
		if (!$this->user->hasPermission('modify', 'extension/module/elfsight_pinterest_feed')) {
    ...
    public function setDeactivateReasons() {
        return require ( './controller/extension/module/pinterest-feed-assets/reasons.php' );
    }
    ...
    public function uninstall() {
        ...
        include './controller/extension/module/pinterest-feed-assets/popup.php';
    }
