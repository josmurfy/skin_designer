<?php
class ControllerExtensionModuleShipstation extends Controller {
    private $error = array();
    ...
    public function index() {
        ...
        $this->response->setOutput($this->load->view('extension/module/shipstation.tpl', $data));
    }
    ...
    protected function validate() {
        if (!$this->user->hasPermission('modify', 'extension/module/shipstation')) {
