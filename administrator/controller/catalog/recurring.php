...
class ControllerCatalogRecurring extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('catalog/recurring', 'user_token=' . $this->session->data['token'] . $url, true));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('catalog/recurring', 'user_token=' . $this->session->data['token'] . $url, true)
		);

		$data['add'] = $this->url->link('catalog/recurring/add', 'user_token=' . $this->session->data['token'] . $url, true);
		$data['copy'] = $this->url->link('catalog/recurring/copy', 'user_token=' . $this->session->data['token'] . $url, true);
		$data['delete'] = $this->url->link('catalog/recurring/delete', 'user_token=' . $this->session->data['token'] . $url, true);
		...
		foreach ($results as $result) {
			$data['recurrings'][] = array(
				...
				'edit'         => $this->url->link('catalog/recurring/edit', 'user_token=' . $this->session->data['token'] . '&recurring_id=' . $result['recurring_id'] . $url, true)
			);
		}
		...
		$data['sort_name'] = $this->url->link('catalog/recurring', 'user_token=' . $this->session->data['token'] . '&sort=pd.name' . $url, true);
		$data['sort_sort_order'] = $this->url->link('catalog/recurring', 'user_token=' . $this->session->data['token'] . '&sort=p.sort_order' . $url, true);
		...
		$pagination->url = $this->url->link('catalog/recurring', 'user_token=' . $this->session->data['token'] . $url . '&page={page}', true);
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['recurring_id'])) {
			$data['action'] = $this->url->link('catalog/recurring/add', 'user_token=' . $this->session->data['token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('catalog/recurring/edit', 'user_token=' . $this->session->data['token'] . '&recurring_id=' . $this->request->get['recurring_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('catalog/recurring', 'user_token=' . $this->session->data['token'] . $url, true);
