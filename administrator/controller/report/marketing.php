...
class ControllerReportMarketing extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('report/marketing', 'user_token=' . $this->session->data['token'] . $url, true)
		);
		...
		foreach ($results as $result) {
			...
			$action[] = array(
				...
				'href' => $this->url->link('marketing/marketing/edit', 'user_token=' . $this->session->data['token'] . '&marketing_id=' . $result['marketing_id'] . $url, true)
			);
		...
		$pagination->url = $this->url->link('report/marketing', 'user_token=' . $this->session->data['token'] . $url . '&page={page}', true);
