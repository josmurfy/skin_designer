...
class ControllerReportCustomerCredit extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('report/customer_credit', 'user_token=' . $this->session->data['token'] . $url, true)
		);
		...
		foreach ($results as $result) {
			$data['customers'][] = array(
				...
				'edit'           => $this->url->link('customer/customer/edit', 'user_token=' . $this->session->data['token'] . '&customer_id=' . $result['customer_id'] . $url, true)
			);
		}
		...
		$pagination->url = $this->url->link('report/customer_credit', 'user_token=' . $this->session->data['token'] . $url . '&page={page}', true);
