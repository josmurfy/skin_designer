...
class ControllerReportProductViewed extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('report/product_viewed', 'user_token=' . $this->session->data['token'] . $url, true)
		);
		...
		$data['reset'] = $this->url->link('report/product_viewed/reset', 'user_token=' . $this->session->data['token'] . $url, true);
		...
		$pagination->url = $this->url->link('report/product_viewed', 'user_token=' . $this->session->data['token'] . '&page={page}', true);
	...
	public function reset() {
		...
		$this->response->redirect($this->url->link('report/product_viewed', 'user_token=' . $this->session->data['token'], true));
	}
}