...
class ControllerReportAffiliate extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('report/affiliate', 'user_token=' . $this->session->data['token'] . $url, true)
		);
		...
		foreach ($results as $result) {
			$data['affiliates'][] = array(
				...
				'edit'       => $this->url->link('marketing/affiliate/edit', 'user_token=' . $this->session->data['token'] . '&affiliate_id=' . $result['affiliate_id'] . $url, true)
			);
		}
		...
		$pagination->url = $this->url->link('report/affiliate', 'user_token=' . $this->session->data['token'] . $url . '&page={page}', true);
