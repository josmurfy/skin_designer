...
class ControllerReportCustomerReward extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('report/customer_reward', 'user_token=' . $this->session->data['token'] . $url, true)
		);
		...
		$pagination->url = $this->url->link('report/customer_reward', 'user_token=' . $this->session->data['token'] . $url . '&page={page}', true);
