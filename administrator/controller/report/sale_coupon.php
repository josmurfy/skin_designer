...
class ControllerReportSaleCoupon extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('report/sale_coupon', 'user_token=' . $this->session->data['token'] . $url, true)
		);
		...
		foreach ($results as $result) {
			$data['coupons'][] = array(
				...
				'edit'   => $this->url->link('marketing/coupon/edit', 'user_token=' . $this->session->data['token'] . '&coupon_id=' . $result['coupon_id'] . $url, true)
			);
		}
		...
		$pagination->url = $this->url->link('report/sale_coupon', 'user_token=' . $this->session->data['token'] . $url . '&page={page}', true);
