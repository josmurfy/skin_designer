...
class ControllerReportAffiliateActivity extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			'href' => $this->url->link('report/affiliate_activity', 'user_token=' . $this->session->data['token'] . $url, true),
		...
		foreach ($results as $result) {
			...
			$data['activities'][] = array(
				'comment'    => str_replace('affiliate_id=', $this->url->link('marketing/affiliate/edit', 'user_token=' . $this->session->data['token'] . '&affiliate_id=', true), $comment),
				'ip'         => $result['ip'],
		...
		$pagination->url = $this->url->link('report/affiliate_activity', 'user_token=' . $this->session->data['token'] . $url . '&page={page}', true);
