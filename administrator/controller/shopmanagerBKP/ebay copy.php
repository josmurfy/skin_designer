...
class ControllerShopmanagerEbay extends Controller {
    ...
    public function editPrice(){
       ...
       $this->request->post['product_id']=$this->request->post['product_id']??11472;//$this->request->get['product_id'];
       ...
       $this->request->post['price']=$this->request->post['price']??6.61;//$this->request->get['price'];
