...
class ControllerEbayMapEbayMapProduct extends Controller {
    ...
    public function index() {
		...
		$data['import_from_ebay'] = $this->url->link('ebay_map/ebay_map_product/', 'user_token=' . $this->session->data['token'] . $url, true);
		$data['delete'] = $this->url->link('ebay_map/ebay_map_product/delete', 'user_token=' . $this->session->data['token'] . $url, true);
		...
		if (isset($this->request->get['account_id'])) {
			...
			$data['clear_product_filter'] 	= $this->url->link('ebay_map/ebay_account/edit', 'user_token=' . $this->session->data['token'] .'&account_id=' . $this->request->get['account_id']. '&status=account_product_map', true);
		}
		...
		if(isset($this->request->get['account_id'])){
			$data['redirect'] 	= html_entity_decode($this->url->link('ebay_map/ebay_account/edit', 'user_token=' . $this->session->data['token'] . '&status=account_product_map&account_id=' .$this->request->get['account_id'] , true));
		}else{
	...
	public function deleteMapProduct() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete() && $this->request->get['account_id']) {
			...
			if($result)
				...
				$json['redirect'] 				= html_entity_decode($this->url->link('ebay_map/ebay_account/edit', 'user_token=' . $this->session->data['token'] . '&status=account_product_map&account_id=' .$this->request->get['account_id'] , true));
		}
		if(isset($this->error['warning'])){
