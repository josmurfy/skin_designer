...
class ControllerSaleRecurring extends Controller {
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('sale/recurring', 'user_token=' . $this->session->data['token'] . $url, true)
		);
		...
		foreach ($results as $result) {
			...
			$data['recurrings'][] = array(
				...
				'view'               => $this->url->link('sale/recurring/info', 'user_token=' . $this->session->data['token'] . '&order_recurring_id=' . $result['order_recurring_id'] . $url, true),
				'order'              => $this->url->link('sale/order/info', 'user_token=' . $this->session->data['token'] . '&order_id=' . $result['order_id'], true)
			);
		}
		...
		$data['sort_order_recurring'] = $this->url->link('sale/recurring', 'user_token=' . $this->session->data['token'] . '&sort=or.order_recurring_id' . $url, true);
		$data['sort_order'] = $this->url->link('sale/recurring', 'user_token=' . $this->session->data['token'] . '&sort=or.order_id' . $url, true);
		$data['sort_reference'] = $this->url->link('sale/recurring', 'user_token=' . $this->session->data['token'] . '&sort=or.reference' . $url, true);
		$data['sort_customer'] = $this->url->link('sale/recurring', 'user_token=' . $this->session->data['token'] . '&sort=customer' . $url, true);
		$data['sort_status'] = $this->url->link('sale/recurring', 'user_token=' . $this->session->data['token'] . '&sort=or.status' . $url, true);
		$data['sort_date_added'] = $this->url->link('sale/recurring', 'user_token=' . $this->session->data['token'] . '&sort=or.date_added' . $url, true);
		...
		$pagination->url = $this->url->link('sale/recurring', 'user_token=' . $this->session->data['token'] . '&page={page}' . $url, true);
	...
	public function info() {
		...
		if ($order_recurring_info) {
			...
			$data['cancel'] = $this->url->link('sale/recurring', 'user_token=' . $this->session->data['token'] . $url, true);
			...
			if ($order_recurring_info['recurring_id']) {
				$data['recurring'] = $this->url->link('catalog/recurring/edit', 'user_token=' . $this->session->data['token'] . '&recurring_id=' . $order_recurring_info['recurring_id'], true);
			} else {
				$data['recurring'] = '';
			}			
			...
			$data['order'] = $this->url->link('sale/order/info', 'user_token=' . $this->session->data['token'] . '&order_id=' . $order_info['order_id'], true);
			$data['firstname'] = $order_info['firstname'];
			$data['lastname'] = $order_info['lastname'];
			
			if ($order_info['customer_id']) {
				$data['customer'] = $this->url->link('customer/customer/edit', 'user_token=' . $this->session->data['token'] . '&customer_id=' . $order_info['customer_id'], true);
			} else {
				$data['customer'] = '';
			}
