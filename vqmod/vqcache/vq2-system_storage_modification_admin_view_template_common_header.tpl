...
<header id="header" class="navbar navbar-static-top">
  ...
  <ul class="nav pull-right">
			...
			<?php if (!empty($dbcache_status)) { ?>
				<li><a href="<?php echo $dbcache_clear; ?>" data-bs-toggle="tooltip" data-placement="left" title="<?php echo $text_dbcache_clear; ?>"><i class="fa fa-database"></i></a></li>
			<?php } ?>
			
			
    <li class="dropdown"><a class="dropdown-toggle" data-bs-toggle="dropdown"><?php if($alerts > 0) { ?><span class="label label-danger pull-left"><?php echo $alerts; ?></span><?php } ?> <i class="fa fa-bell fa-lg"></i></a>
