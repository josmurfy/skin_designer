    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <table class="table table-bordered">
        ...
        <tr>
          <td></td>
          <?php foreach ($products as $product) { ?>
          <td><?php if ($product['quantity'] <= 0) { ?> <input type="button" value="<?php echo $product['stock_status']; ?>" class="btn btn-primary btn-block" style="cursor: default !important; background: gray !important; color: lightgray !important;" /> <?php } else { ?> <?php if ($product['quantity'] <= 0) { ?>
<input type="button" value="<?php echo $product['stock_status']; ?>" class="btn btn-primary btn-block" style="cursor: default !important; background: gray !important; color: lightgray !important;" />
<?php } else { ?>
