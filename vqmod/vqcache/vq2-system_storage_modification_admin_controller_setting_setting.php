...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['token'] = $this->session->data['token'];
            ...
            if (isset($this->request->post['config_api_fixer'])) {
			$data['config_api_fixer'] = $this->request->post['config_api_fixer'];
		} else {
			$data['config_api_fixer'] = $this->config->get('config_api_fixer');
		}
