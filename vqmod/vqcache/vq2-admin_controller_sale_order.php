...
public function export() {
        ...
        $orders_list = array();
			...
			$orders_list[] = array(
				...
				'shipping_county'      => $result['shipping_county'],
				'shipping_postcode'      => $result['shipping_postcode'],
				'itemtitle'    => $result['itemtitle'],
				'quantity'    => $result['quantity'],
				'total'         => number_format($result['total'], 2, '.', ''),//$this->currency->format($result['total'], $result['currency_code'], $result['currency_value']),
				'customlabel'  =>  $result['customlabel'],
				'weight'=>  number_format($result['weight']*$result['quantity'], 2, '.', ''), 
        ...
        $orders_column = array('SalesRecordNumber', 'BuyerFullname', 'BuyerEmail', 'BuyerPhone', 'BuyerAddress1', 'BuyerCity', 'BuyerState','BuyerZip', 'ItemTitle','Quantity','SalePrice','CustomLabel','weight', 'length', 'width', 'height','Currency Code', 'Date Added', 'Order Status');
				...
				foreach ($products as $product) {
					...
					if ($product_info) {
						...
						$product_data[] = array(
							...
							'option'   => $option_data,
							'quantity' => $product['quantity'],
							'unallocated_quantity' => $product_info['unallocated_quantity'],
							'quantity' => $product_info['quantity'],
							'location_magasin' => $product_info['location_magasin'],
							'location_entrepot' => $product_info['location_entrepot'],
